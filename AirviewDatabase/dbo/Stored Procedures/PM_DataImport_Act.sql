CREATE PROCEDURE [dbo].[PM_DataImport_Act]
	@Filter NVARCHAR(50),
...
BEGIN
	...
	BEGIN
		...
		insert into FSM4_Sites(FA_Code,USID,[Common ID],REGION,MARKET,[SUB Market],Street_Address,CITY,State,ZIP,COUNTY,Latitude,Longitude,vMME,[Controlled Introduction],[Super Bowl],
		DAS_or_Inbuilding,[FirstNet RAN], [iPlan Job], [iPlan Status], [PACE Number], [iPlan Issue Date], TSS_Plan, TSS_Forecast, TSS_Submitted, Site_Specific_Material_Available_Forecast, Site_Specific_Material_Available_Actual,
