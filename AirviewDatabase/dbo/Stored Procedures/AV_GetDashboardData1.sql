...
CREATE PROCEDURE [dbo].[AV_GetDashboardData1] 
...
BEGIN
	--WORK ORDER VIEW
	EXEC [AV_GetDashboardSites]  @CHILDFILTER, @PARENTFILTER, @FROMDATE, @TODATE, @UserID, @Panel1Option, @Panel1Value, @Panel2Option, @Panel2Value, 'Dashboard_Sites',0,5, @CountryId, @Client, @Scopes
	...
	--REGION SUMMARY
	Exec AV_SummaryView @PARENTFILTER, @CHILDFILTER, @FROMDATE, @TODATE, @Panel1Option, @Panel1Value , @UserID, @Panel2Option, @Panel2Value, @CountryId, @Client, @Scopes

	--Tester SUMMARY
	Exec AV_SummaryView @PARENTFILTER, @CHILDFILTER,@FROMDATE, @TODATE, @Panel2Option,@Panel2Value, @UserID, @Panel1Option, @Panel1Value, @CountryId, @Client, @Scopes
...
--  from AD_Definations x where DefinationTypeId=17
 ...
 EXEC [AV_GetDashboardSites]  @CHILDFILTER, @PARENTFILTER, @FROMDATE, @TODATE, @UserID, @Panel1Option, @Panel1Value, @Panel2Option, @Panel2Value, 'Dashboard_Markers',0,5, @CountryId, @Client, @Scopes