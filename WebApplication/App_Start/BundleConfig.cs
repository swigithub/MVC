    ...
    public class BundleConfig
    {
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/datepicker/js").Include(
                                         ...
                                         "~/AdminLTE/plugins/datepicker/js/custom-datepicker.js",
                                         "~/AdminLTE/plugins/datepicker/js/date.format.js"));
            ...
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/QueryBuilder/js").Include(
                                         "~/Content/js/Plugins/QueryBuilder/js/jQuery.extendext.js",
                                         "~/Content/js/Plugins/QueryBuilder/js/query-builder.js",
                                         "~/Content/js/Plugins/QueryBuilder/js/query-builder.standalone.js",
                                         "~/Content/js/Plugins/QueryBuilder/js/query-builder.en.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/QueryBuilder/css").Include(
                                       "~/Content/js/Plugins/QueryBuilder/css/query-builder.default.css"));

            // plugins | Select
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/select2/js").Include(
                                         "~/AdminLTE/plugins/select2/js/select2.js"));
            ...
            // plugins | notify
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/notify/js").Include(
                                         "~/Content/js/Plugins/notify/js/notify.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/notify/css").Include(
                                        "~/Content/js/Plugins/notify/css/notify.css"));

            // plugins | Confirm
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/Confirm/js").Include(
                                         "~/Content/js/Plugins/Confirm/js/confirm.min.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/Confirm/css").Include(
                                        "~/Content/js/Plugins/Confirm/css/confirm.min.css"));

            // plugins | Pagination
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/Pagination/js").Include(
                                         "~/Content/js/Plugins/Pagination/js/simplePagination.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/Pagination/css").Include(
                                        "~/Content/js/Plugins/Pagination/css/simplePagination.css"));

            // plugins | KML
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/kml/js").Include(
                                         "~/Content/js/Plugins/kml/js/geoxml3.js",
                                         "~/Content/js/Plugins/kml/js/ProjectedOverlay.js"));

            // plugins | ColorPicker
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/ColorPicker/js").Include(
                                         "~/Content/js/Plugins/ColorPicker/js/spectrum.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/ColorPicker/css").Include(
                                        "~/Content/js/Plugins/ColorPicker/css/spectrum.css"));

            // plugins | MultiselectBootstrap
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/MultiselectBootstrap/js").Include(
                                         "~/Content/js/Plugins/MultiselectBootstrap/js/bootstrap-multiselect.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/MultiselectBootstrap/css").Include(
                                        "~/Content/js/Plugins/MultiselectBootstrap/css/bootstrap-multiselect.css"));

            // plugins | jqGrid
            bundles.Add(new ScriptBundle("~/Content/js/Plugins/jqGrid/js").Include(
                                         "~/Content/js/Plugins/jqGrid/js/jquery.jqGrid.min.js",
                                         "~/Content/js/Plugins/jqGrid/js/grid.locale-en.js"));

            bundles.Add(new StyleBundle("~/Content/js/Plugins/jqGrid/css").Include(
                                        "~/Content/js/Plugins/jqGrid/css/ui.jqgrid.css",
                                        "~/Content/js/Plugins/jqGrid/css/ui.jqgrid-bootstrap-ui.css"));
        ...
        {
            // bootstrap
            bundles.Add(new ScriptBundle("~/Content/js/Dashboard/js").Include(
                "~/Content/js/Dashboard/js/SiteRoute.js"
                ,"~/Content/js/Dashboard/js/Dashboard.js"
                , "~/Content/js/Dashboard/js/SiteGrid.js"
                ));
