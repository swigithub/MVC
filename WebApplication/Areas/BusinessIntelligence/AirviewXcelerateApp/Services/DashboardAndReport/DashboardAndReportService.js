...
var countt = 0;
var parentWidgetId = "-1";
var widgetClckStatus = true;
var gscope;
var gcompile;
var grootScope;
var edgeDelStatus = true;
var gtoastr;
var lastUrl = "";
//#endregion

//#region Dashboard and Report
airviewXcelerateApp.factory('DashboardAndReport', function ($http, $timeout, ivhTreeviewMgr, $uibModal) {
    ...
    var dashboardAndReportHandler = function () {
        ...
        var handleRandomColor = function () {
        ...
        var handleDragWidget = function (element, parentElement, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, queryBuilderElement, queryBuilerSelector, compile, scope, vm, widgetType, toastrss, parentWidgetID, drillDownParams) {

            //#region widget object initialization
            let widgetInfo = {};
            widgetInfo.widgetConfiguration = {};
            widgetInfo.widgetConfiguration.shtrType = currentShutterType;
            widgetInfo.widgetConfiguration.isRender = drillDownParams.isRender;
            ...
            widgetInfo.widgetName = drillDownParams.title;
            ...
            widgetInfo.widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo = [];
            widgetInfo.treeviewOfMultiDatasetsWithItsColumns = [];
            widgetInfo.finalQueryRef = "";
            widgetInfo.loading = false;
            widgetInfo.mxModel;
            widgetInfo.mxEditor;
            widgetInfo.mxGraph;
            ...
            //addedby sohail
            //save document list for documents
            //widgetInfo.documentListFromDB = [];
            ...
            $(compiledcode).find('.grid-stack-item-content').attr("ng-class", "[vm.modeType" + "," + "vm.dashboardAndReportComInformation.widgetList[" + getLengthOfWidgetList + "].widgetConfiguration.classInfo.widgetheader]");
            $(compiledcode).find('.grid-stack-item-content').attr("ng-class", "[vm.modeType" + "," + "vm.dashboardAndReportComInformation.widgetList[" + getLengthOfWidgetList + "].widgetConfiguration.classInfo.widgetheader]");
            ...
            $(compiledcode).find(".maps").attr("style", "height:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + getLengthOfWidgetList + '].widgetConfiguration.styleInfo.widgetHeight' + "}}px;position: relative; overflow: hidden;");
            ...
            if (parentWidgetID != null) {
                ...
                $(compiledcode).find('.widget').addClass('child-widget-tab');
            }
            else {

                $(compiledcode).find('.widget').addClass('parent-widget');
            }
            ...
            if (widgetType == 'widgetOfTable') {
                ...
                widgetInfo.widgetConfiguration.styleInfo.theadFontSize = 16;
                widgetInfo.widgetConfiguration.styleInfo.trowFontSize = 13;
            ...
            if (widgetType == "widgetOfMap") {
                ...
                widgetInfo.mapConfigurations = {};
                widgetInfo.mapConfigurations['mapLatLng'] = {};
                widgetInfo.mapConfigurations['mapLatLng']['Lat'] = undefined;
                widgetInfo.mapConfigurations['mapLatLng']['Lng'] = undefined;
                widgetInfo.mapColumnLatLng = [];
            }
            //#endregion

            //#region charts configuration
            if (widgetType == 'widgetOfChart') {
                if (widgetInfo.widgetConfiguration.isRender)
                    widgetInfo.activeWidgetIndex = getLengthOfWidgetList;
                widgetInfo.chartConfigurations = {};
                widgetInfo.chartConfigurations.chartInitialization = {};
                widgetInfo.chartConfigurations.settings = {};

                //#region drilldown charts

                widgetInfo.chartConfigurations.drilldownParams = {};
                widgetInfo.chartConfigurations.drilldownParams.prevUniqueKey = drillDownParams.prevUniqueKey;
                widgetInfo.chartConfigurations.drilldownParams.nextUniqueKey = drillDownParams.nextUniqueKey
                widgetInfo.chartConfigurations.drilldownParams.rendorUniqueKey = drillDownParams.rendorUniqueKey == null ? widgetInfo.widgetID : drillDownParams.rendorUniqueKey;
                widgetInfo.chartConfigurations.drilldownParams.isDrilldownStatus = drillDownParams.isDrilldownStatus;
                if (drillDownParams.isDrilldownStatus) {

                    vm.dashboardAndReportComInformation.widgetList[drillDownParams.previousWidgetIndex].chartConfigurations.drilldownParams.nextUniqueKey = widgetInfo.widgetID;
                    vm.dashboardAndReportComInformation.widgetList[drillDownParams.renderWidgetIndex].activeWidgetIndex = getLengthOfWidgetList;
                }
                ...
                widgetInfo.chartConfigurations.settings.XaxisSettings.valueFormattingDropdown = '';
                widgetInfo.chartConfigurations.settings.XaxisSettings.valueFormattingInput = '';
                ...
                widgetInfo.chartConfigurations.settings.YaxisSettings.valueFormattingDropdown = '';
                widgetInfo.chartConfigurations.settings.YaxisSettings.valueFormattingInput = '';
                ...
                $(settings).find('.xValueFormattingDropdown').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + getLengthOfWidgetList + '].chartConfigurations.settings.XaxisSettings.valueFormattingDropdown');
                $(settings).find('.xValueFormattingInput').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + getLengthOfWidgetList + '].chartConfigurations.settings.XaxisSettings.valueFormattingInput');
                //#endregion
                ...
                $(settings).find('.xValueFormattingDropdown').attr('ng-change', ' vm.chart.settings.XaxisSettings.valueFormattingDropdown(' + getLengthOfWidgetList + ')');
                $(settings).find('.xValueFormattingInput').attr('ng-blur', ' vm.chart.settings.XaxisSettings.valueFormattingInput(' + getLengthOfWidgetList + ')');
                //#endregion

                //#endregion.XaxisSettings.suffix
                ...
                $(settings).find('.yValueFormattingDropdown').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + getLengthOfWidgetList + '].chartConfigurations.settings.YaxisSettings.valueFormattingDropdown');
                $(settings).find('.yValueFormattingInput').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + getLengthOfWidgetList + '].chartConfigurations.settings.YaxisSettings.valueFormattingInput');
                //#endregion
                ...
                $(settings).find('.yValueFormattingDropdown').attr('ng-change', ' vm.chart.settings.YaxisSettings.valueFormattingDropdown(' + getLengthOfWidgetList + ')');
                $(settings).find('.yValueFormattingInput').attr('ng-blur', ' vm.chart.settings.YaxisSettings.valueFormattingInput(' + getLengthOfWidgetList + ')');
                //#endregion
            ...
            if (widgetType == 'widgetOfDefault') {
                ...
                widgetInfo.defaultPageConfiguration.staClName = undefined;
                widgetInfo.defaultPageConfiguration.isColumnRange = 1;
                widgetInfo.defaultPageConfiguration['layoutTypeDefaultPage'] = "Layout 1";
                widgetInfo.defaultPageConfiguration['statusColors'] = [];
                widgetInfo.fileInformation = [];
                widgetInfo.stClrColNames = [];
            ...
            if (widgetType == 'widgetOfDocument') {
                ...
                widgetInfo.documentPathList = [];
                handleDocumentPath(vm, scope, compile, false, getLengthOfWidgetList);
            ...
            //#region Form.io
            if (widgetType == 'widgetOfFormDotIo') {
                widgetInfo.widgetConfiguration.idsInfo.builderId = handleUniquekey(6);
                widgetInfo.widgetConfiguration.idsInfo.formIoId = handleUniquekey(6);
                widgetInfo.formDotIoConfigurations = {};
                widgetInfo['formBuilder'] = {};
                widgetInfo.formDotIoConfigurations['components'] = [];
                widgetInfo.formDotIoConfigurations['formData'] = {};
                widgetInfo.builderNFormStatus = true;
                widgetInfo.builderNFormIcon = "fa fa-building";
                widgetInfo['deletedComponent'] = [];
                $(compiledcode).find(".content-wrapper > .builder-form-io").attr('id', vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].widgetConfiguration.idsInfo.builderId);
                $(compiledcode).find(".content-wrapper > .sub-form-io").attr('id', vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].widgetConfiguration.idsInfo.formIoId);


            }
            if (widgetType == 'widgetOfPredefined') {
                widgetInfo.predefineWidget = {};
                widgetInfo.predefineWidget.coreType = drillDownParams.coreDataType;
            ...
            if (widgetType == "widgetOfDefault") {
                let staColor = getWidgetSettings.find(x => x.type == widgetType).statusColorSettings
                staColor = $.parseHTML(staColor.replace(/chngeIdx/g, getLengthOfWidgetList));
                $(staColor).addClass(vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].widgetID);
                staColor = compile(staColor)(scope);
                $(settingsAndAdvanceSettingsSelector).append(staColor);
            }
            //#endregion
            ...
            var queryBuilerParse = queryBuilderElement.replace(/chngeIdx/g, getLengthOfWidgetList);
            if (!widgetInfo.widgetConfiguration.isRender)
                queryBuilerParse = queryBuilerParse.replace(/baseRendorIdx/g, drillDownParams.renderWidgetIndex);
            else
                queryBuilerParse = queryBuilerParse.replace(/baseRendorIdx/g, getLengthOfWidgetList);

            queryBuilerParse = $.parseHTML(queryBuilerParse)
            ...
            //#region default page draggable and droppable
            if (widgetType == "widgetOfTab")
                handleDroppableOnTabWidget(vm, getLengthOfWidgetList, compile, scope);
            //#endregion
            if (widgetType == 'widgetOfFormDotIo') {
                handleFormDotIoInialization(vm, getLengthOfWidgetList, scope, compile, vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].formBuilder);

            }
            if (widgetType == "widgetOfPredefined") {
                let getIcon = vm.dynamicPridefinedWidget.find(x=>x.coreType == widgetInfo.predefineWidget.coreType).icon;
                $('#' + vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].widgetID).find('.content-wrapper >.center-icon >i').attr('class', getIcon);
                handleInitPredefinedView(vm, getLengthOfWidgetList, scope, compile, $('#' + vm.dashboardAndReportComInformation.widgetList[getLengthOfWidgetList].widgetID).find('.content-wrapper'))
            }
            if (widgetType == "widgetOfDocument") {
                countt++;
                scope.$apply();
        ...
        var handleRenderWidget = function (element, parentElement, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, queryBuilderElement, queryBuilerSelector, compile, scope, vm, index, widgetType, uiGridConstants, rootScope, positionAuto, parentWidgetID) {
            ...
            //#region render database if exists
            //   handleCheckCentralizeDatabaseExistOrNot(vm, index, scope, compile);
            //#endregion
            ...
            if (widgetType != "widgetOfTab" && vm.coreModeTypeInte == "EDIT")
            ...
            $(compiledcode).find('.grid-stack-item-content').attr("ng-class", "[vm.modeType" + "," + "vm.dashboardAndReportComInformation.widgetList[" + index + "].widgetConfiguration.classInfo.widgetheader]");
            ...
            $(compiledcode).find(".maps").attr("style", "height:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + index + '].widgetConfiguration.styleInfo.widgetHeight' + "}}px;position: relative; overflow: hidden;");
            if (parentWidgetID != null) {
            ...
            if (widgetType == 'widgetOfFormDotIo') {
                ...
                $(compiledcode).find(".content-wrapper > .builder-form-io").attr('id', vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.idsInfo.builderId);
                $(compiledcode).find(".content-wrapper > .sub-form-io").attr('id', vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.idsInfo.formIoId);
            ...
            if (widgetType == 'widgetOfChart') {
                ...
                $(settings).find('.xValueFormattingDropdown').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + index + '].chartConfigurations.settings.XaxisSettings.valueFormattingDropdown');
                $(settings).find('.xValueFormattingInput').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + index + '].chartConfigurations.settings.XaxisSettings.valueFormattingInput');
                //#endregion
                ...
                $(settings).find('.xValueFormattingDropdown').attr('ng-change', ' vm.chart.settings.XaxisSettings.valueFormattingDropdown(' + index + ')');
                $(settings).find('.xValueFormattingInput').attr('ng-blur', ' vm.chart.settings.XaxisSettings.valueFormattingInput(' + index + ')');
                //#endregion
                ...
                $(settings).find('.yValueFormattingDropdown').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + index + '].chartConfigurations.settings.YaxisSettings.valueFormattingDropdown');
                $(settings).find('.yValueFormattingInput').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + index + '].chartConfigurations.settings.YaxisSettings.valueFormattingInput');
                //#endregion
                ...
                $(settings).find('.yValueFormattingDropdown').attr('ng-change', ' vm.chart.settings.YaxisSettings.valueFormattingDropdown(' + index + ')');
                $(settings).find('.yValueFormattingInput').attr('ng-blur', ' vm.chart.settings.YaxisSettings.valueFormattingInput(' + index + ')');
                //#endregion
            ...
            //#region widget compile and render section
            compiledcode = compile(compiledcode)(scope);
            if (vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.isRender)
            ...
            //#region settings of widget compile and render section
            settings = compile(settings)(scope);
            if ($(settingsAndAdvanceSettingsSelector).length > 0)
                $(settingsAndAdvanceSettingsSelector).append(settings);
            ...
            if (widgetType == "widgetOfDefault") {
                let staColor = getWidgetSettings.find(x => x.type == widgetType).statusColorSettings
                staColor = $.parseHTML(staColor.replace(/chngeIdx/g, index));
                $(staColor).addClass(vm.dashboardAndReportComInformation.widgetList[index].widgetID);
                staColor = compile(staColor)(scope);
                $(settingsAndAdvanceSettingsSelector).append(staColor);
            }
            //#region query builder section
            var queryBuilerParse = queryBuilderElement.replace(/chngeIdx/g, index);
            if (!vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.isRender) {
                let renderIndx = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[index].chartConfigurations.drilldownParams.rendorUniqueKey);
                queryBuilerParse = queryBuilerParse.replace(/baseRendorIdx/g, renderIndx);
            }
            else {
                queryBuilerParse = queryBuilerParse.replace(/baseRendorIdx/g, index);
            }
            queryBuilerParse = $.parseHTML(queryBuilerParse);
            ...
            var queryBuilerCompile = compile(queryBuilerParse)(scope);
            if ($(queryBuilerSelector).length > 0)
                $(queryBuilerSelector).append(queryBuilerCompile);
            ...
            $timeout(function () {
                ...
                if (vm.coreModeTypeInte == "EDIT") {
                    handleRenderSelectedColumnUsingJson(vm, index, compile, scope, vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.historyOfQueryBuilder);

                    handleRenderOnlySubqueryColumnWithMainSelectedColumn(vm, index, scope, compile);
                }
                //comments
            ...
            switch (widgetType) {
                case 'widgetOfFormDotIo':

                    setTimeout(function () { handleFormDotIoInialization(vm, index, scope, compile, vm.dashboardAndReportComInformation.widgetList[index].formDotIoConfigurations.components) }, 1000);


                    break;
                case 'widgetOfTab':
                    handleDrawChildWidgetsIfExist(compiledcode, vm, index, compile, scope, uiGridConstants, rootScope);
                    handleDroppableOnTabWidget(vm, index, compile, scope);
                    //$timeout(function () {
                ...
                case 'widgetOfChart':
                    ...
                    setTimeout(function () {
                        if (vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.isRender) {
                            handleChartFromDb(compile, scope, vm, uiGridConstants, index, false);
                            vm.dashboardAndReportComInformation.widgetList[index].activeWidgetIndex = index;
                        }
                    }, 300);
                    break;
                case 'widgetOfMap':
                    handleMaps(compile, scope, vm, index, false);
                    handleAssignColumnNameLatLngForMap(vm, index);
                    break;
                case 'widgetOfDocument':
                    //handleMaps(compile, scope, vm, index, false);
                    break;
                case 'widgetOfPredefined':
                    let getIcon = vm.dynamicPridefinedWidget.find(x=>x.coreType == vm.dashboardAndReportComInformation.widgetList[index].predefineWidget.coreType).icon;

                    $('#' + vm.dashboardAndReportComInformation.widgetList[index].widgetID).find('.content-wrapper >.center-icon >i').attr('class', getIcon);
                    handleInitPredefinedView(vm, index, scope, compile, $('#' + vm.dashboardAndReportComInformation.widgetList[index].widgetID).find('.content-wrapper'))
                    break;
                case 'widgetOfDefault':
                    handleLoadColumnsInSettingsOfDefaultPage(vm, index, scope, compile);
                    handleAssignColumnNameStatusName(vm, index);
                    //hanldeDefaultPage(compile, scope, vm, index, false).done(function (res) {
                    //    console.log('called');
                    //});
                    ...
                    $timeout(function () {
                        ...
                        if (getLengthDataMember > 0) {
                            ...
                            hanldeDefaultPage(compile, scope, vm, index, false).done(function (res) {
                                ...
                                switch (vm.dashboardAndReportComInformation.widgetList[index].defaultPageConfiguration.layoutTypeDefaultPage) {
                                    case "Layout 1":
                                        handleDrawDataRowsColumnsFormWithDefaultPage(vm, index, scope, compile);
                                        break;
                                    case "Layout 2":
                                        handleDrawDataRowsColumnsFormWithDefaultPageSecondLayout(vm, index, scope, compile);
                                        break;
                            ...
                            //setTimeout(function () { handleDrawDataRowsColumnsFormWithDefaultPage(vm, index, scope, compile); }, 180)
                        }
                    }, 150);
            ...
            if (vm.dashboardAndReportComInformation.widgetList[index].widgetType == "widgetOfDocument") {
                ...
                handleDocumentPath(vm, scope, compile, true, index);
                handleGetDocuments(vm.dashboardAndReportComInformation.widgetList[index].documentsViewConfiguration.documentPath, $('#' + vm.dashboardAndReportComInformation.widgetList[index].widgetID).find('.document-area'));

            }
        };
        //#endregion

        //#region form.io initialization
        var handleFormDotIoInialization = function (vm, widgetIndex, scope, compile, comp) {
            Formio.builder(document.getElementById(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.idsInfo.builderId), comp, {}).then(handleEventForFormDotIo.bind(null, vm, widgetIndex, scope, compile, comp));


        };
        //#endregion

        //#region Event for form dot io

        var handleEventForFormDotIo = function (vm, widgetIndex, scope, compile, comp, builder) {
            builder.nosubmit = true;
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].formBuilder = builder;
            builder.on('saveComponent', function (e) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].formBuilder = builder;
                handleDeletedComponentsSaveOrUpdate(vm, widgetIndex, scope, compile, e);
                if (e.key != matchColName) {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent.push(matchColName);
                    matchColName = "";
                }
            });
            builder.on("editComponent", function (e) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].formBuilder = builder;
                handleDeletedComponentsSaveOrUpdate(vm, widgetIndex, scope, compile, e);
                matchColName = e.key;
            });
            ...
            handleCreateFormForFormDotIo(vm, widgetIndex, scope, compile, comp, builder);
        }

        //#endregion

        //#region form.io reload
        var handleCreateFormForFormDotIo = function (vm, widgetIndex, scope, compile, comp, builder) {
            $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.idsInfo.formIoId).empty();
            Formio.createForm(document.getElementById(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.idsInfo.formIoId), comp, {}).then(function (instance) {
               // handleGetFormDataFromDb(vm, widgetIndex, scope, compile, instance)
                instance.submission = {
                    data: vm.dashboardAndReportComInformation.widgetList[widgetIndex].formDotIoConfigurations.formData[vm.getDataBaseOnId]
                };
                instance.on('submit', function (submission) {
                    handleRemovedColumnFromObject(vm, widgetIndex, scope, compile, submission)
                    if (!vm.dashboardAndReportComInformation.save) {
                        gtoastr.error("Please save the template");
                        return false;
                    }
                   // handleSaveDataOfFormio(vm, widgetIndex, scope, compile, submission.data, instance);
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].formDotIoConfigurations.formData[vm.getDataBaseOnId] = submission.data;
                ...
                builder.on('change', function (schema) {
                    if (schema.components) {
                        ...
                        handleDeletedComponentsOfFormio(event, vm, widgetIndex, scope, compile);
                    }
        ...
        //#region main history deleted component of form.io
        var handleDeletedComponentsOfFormio = function (event, vm, widgetIndex, scope, compile) {
            let getAttributName = $(event.target).parents('.builder-component').find('input').attr('name');
            if (getAttributName) {
                getAttributName = getAttributName.substring(5, getAttributName.length - 1);
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent.push(getAttributName);
            }

        };
        //#endregion

        //#region removed column from  form object on saving time

        var handleRemovedColumnFromObject = function (vm, widgetIndex, scope, compile, submission) {

            for (let i = 0; i < vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent.length; i++) {
                delete submission.data[vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent[i]];
        ...
        //#region  when update or save components with same key,then removed component from deleted history of components 

        var handleDeletedComponentsSaveOrUpdate = function (vm, widgetIndex, scope, compile, saveOrUpdateObject) {
            if (saveOrUpdateObject) {
                let getIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent.findIndex(x=>x == saveOrUpdateObject.key)
                if (getIndex > -1) {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].deletedComponent.splice(getIndex, 1);
                }
        ...
        //#region get form data from db 

        var handleGetFormDataFromDb = function (vm, widgetIndex, scope, compile, instance) {
            $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find('.overlay').attr('style', 'display:block;');
            $.ajax({
                type: "GET",
                url: '/avx2/EntityFormData/GetFormDatabyFormId',
                data: { id: vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID, entityId: vm.getDataBaseOnId },
                success: function (res) {

                    handleMakeJsonOfDataFormio(vm, widgetIndex, scope, compile, instance, res.KeyValues);
        ...
        //#region make json of data according to form.io

        var handleMakeJsonOfDataFormio = function (vm, widgetIndex, scope, compile, instance, formDataDb) {
            let formDataFromDb = {};
            if (formDataDb) {
                for (let i = 0; i < formDataDb.length; i++) {

                    formDataFromDb[formDataDb[i].FormKey] = formDataDb[i].FormValue
        ...
        //#region server call for saving of form.io 

        var handleServerCallForSavingFormio = function (formData) {
            return $.ajax({
                type: "POST",
                url: '/avx2/EntityFormData/SaveFormData',
                data: formData
            });
        }
        //#endregion

        //#region save data of form.io in database with reference id

        var handleSaveDataOfFormio = function (vm, widgetIndex, scope, compile, formData, instance) {
            delete formData['submit'];
            let formDataOfDb = {};
            formDataOfDb['ReferenceId'] = vm.getDataBaseOnId;
            formDataOfDb['FormId'] = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID;
            formDataOfDb['KeyValues'] = [];
            for (let key in formData) {
                let itemObject = {};
                itemObject['FormKey'] = key;
                itemObject['FormValue'] = formData[key];
                formDataOfDb['KeyValues'].push(itemObject);

            }
            $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find('.overlay').attr('style', 'display:block;');
            handleServerCallForSavingFormio(formDataOfDb).success((res) => {

                setTimeout(function () {
                    $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find('.overlay').attr('style', 'display:none;');
                    instance.emit('submitDone', formData)
                    gtoastr.success("Form data has been saved");
                }, 500);
        ...
        //#region remove entire form

        var handleRemoveEntireForm = function (vm, widgetIndex) {
            $.ajax({
                type: "GET",
                url: '/avx2/EntityFormData/DeleteEntityFormData',
                data: { id: vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID, userId: userIDByX1, referenceId: 1 },
                success: function (res) {
        ...
        //#region init predefined view

        var handleInitPredefinedView = function (vm, widgetIndex, scope, compile, preSelector) {

            let getWidgetType = vm.dynamicPridefinedWidget.find(x=>x.coreType == vm.dashboardAndReportComInformation.widgetList[widgetIndex].predefineWidget.coreType);
            dashboardAndReportHandler.log(getWidgetType, false);
            if (getWidgetType) {
                let actualParams = {};
                for (let i = 0; i < getWidgetType.actualParams.length; i++) {
                    if (getWidgetType.actualParams[i].vm)
                        actualParams[getWidgetType.actualParams[i].sP] = vm[getWidgetType.actualParams[i].cP];
                    else
                        actualParams[getWidgetType.actualParams[i].sP] = getWidgetType[getWidgetType.actualParams[i].cP];
                }

                if (vm.getDataBaseOnId)
                    handleRenderPredefinedView(vm, widgetIndex, scope, compile, preSelector, getWidgetType.url, actualParams)
        ...
        var handleRenderPredefinedView = function (vm, widgetIndex, scope, compile, preSelector, url, actualParams) {
            try {
        ...
        //#region check centralize database is exist or not for Remote Subquery

        var handleCheckCentralizeDatabaseExistOrNotForRemoteSubquery = function (vm, widgetIndex, scope, compile) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.length > 0) {
                let remoteSrvLength = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.length;
                for (var i = 0; i < remoteSrvLength ; i++) {
                    let dataSource = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo[i];
                    if (vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']]) {
                        if (vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']])
                            handleAddDatabaseFromClientSide(vm, widgetIndex, scope, compile, { dataSourceName: dataSource['dataSourceName'], remoteDatabase: dataSource['remoteDatabase'] });
                        else {
                            handleGetRemoteDatabaseReloadingtime(vm, widgetIndex, scope, compile, dataSource)
                        }
        ...
        //#region check centralize database is exist or not

        var handleCheckCentralizeDatabaseExistOrNot = function (vm, widgetIndex, scope, compile) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.length > 0) {
                let remoteSrvLength = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.length;
                for (var i = 0; i < remoteSrvLength ; i++) {
                    let dataSource = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo[i];
                    if (vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']]) {
                        if (vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']])
                            handleAddDatabaseFromClientSide(vm, widgetIndex, scope, compile, { dataSourceName: dataSource['dataSourceName'], remoteDatabase: dataSource['remoteDatabase'] });
                        else {
        ...
        var handleGetRemoteDatabaseReloadingtime = function (vm, widgetIndex, scope, compile, dataSource) {
            $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find('.overlay').attr('style', 'display:block;');
            $.ajax({
                type: "POST",
                ...
                success: function (result) {
                    ...
                    if (result.status) {
                        ...
                        let dataSourceNViewsNTablesNColumns = { dataSource: dataSource, viewsTablesNColumn: getData, widgetIndex: widgetIndex };
                        // handleGroupByViewsNTables(getData);

                        handleGroupByViewsNTables(vm, widgetIndex, scope, compile, dataSourceNViewsNTablesNColumns['dataSource'], dataSourceNViewsNTablesNColumns['viewsTablesNColumn']);
                    ...
                    setTimeout(() => { $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find('.overlay').attr('style', 'display:none;'); }, timeout);
        ...
        var addWidgerHandler = function (scope, compile, vm, toastrs) {
            ...
            $(".new-template").droppable({
                ...
                drop: function (event, ui) {
                    ...
                    let getTitle = $(ui.draggable).attr('title');
                    if (panelType == mainPartialViewType) {
                        if (!vm.dynamicPridefinedWidget.find(x=>x.coreType == $(ui.draggable).attr('core-data-type')).renderInMainCanvas) {
                            toastrs.error("This widget can't be used in main canvas");
                            return false;
                        }
                        if (handleCheckPredefinedViewExistOrNot(vm, widgetIndex, scope, compile, panelType, $(ui.draggable).attr('core-data-type'))) {
                            toastrs.error("This widget already existed");
                            return false;
                        }
                    }
                    ...
                    handleDragWidget(getPanelCodeBaseOnWidgetTypeElement.code, addWidgetOfGridStackItem, $(".side-panel .tab-content .tab-pane > .toggle"), getPanelCodeBaseOnWidgetTypeElement.settings, getPanelCodeBaseOnWidgetTypeElement.advanced_settings, getQueryBuilderElement, $(".side-panel #queryBuilderSection"), compile, scope, vm, panelType, toastrs, null, { isRender: true, prevUniqueKey: null, nextUniqueKey: null, rendorUniqueKey: null, isDrilldownStatus: false, coreDataType: $(ui.draggable).attr('core-data-type'), title: getTitle });
                    scope.$apply();
        ...
        var handlejQueryEventsInitialization = function (scope, compile, vm, toastrs) {
            ...
            $(".new-template").on("click", ".widget.parent-widget", function (e) {
                if (widgetClckStatus) {
                    ...
                    if (typeof vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex != "undefined") {
                        widgetIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex;
                        wgtSettingsID = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID;
                    }
                    if (currentWidgetID != wgtSettingsID) {
                        ...
                        parentWidgetId = wgtSettingsID;
                        vm['currentWidgetID'] = currentWidgetID;


                    }
                }
                else {
                    $("." + parentWidgetId).fadeOut();
                }
                widgetClckStatus = true;


                // e.preventDefault();
                //e.stopPropagation();
            });
            $(".new-template").on("click", ".widget.child-widget-tab", function (e) {
                var wgtSettingsID = $(this).parents('.grid-stack-item').attr('id');
                let widgetIndex = Number($(this).parents('.grid-stack-item').attr('data-widgetindex'));
                if (currentWidgetID != wgtSettingsID) {
                    $(this).parent().parent().addClass("change-settings").siblings().removeClass("change-settings");
            ...
            $("body").on("change", ".schema-switch input.m_switch_check", function () {
                if ($(this)[0].className != "query-swith-check m_switch_check") {
                    if ($(this).prop('checked') == true) {
                        ...
                        $(this).parents('.querybuilder-wrapper').find('.delete-edges-vertices').addClass('active');
                    } else {
                        $(this).parents('.querybuilder-inner').find('.airview-schema-designer').removeClass('active');
                        $(this).parents('.querybuilder-wrapper').find('.delete-edges-vertices').removeClass('active');
                    }
                }
            });
            //#endregion
            ...
            //#endregion
            //#region to handle toggle when sidepanel_btn is close or change
            $(".sidepanel-btn").click(function () {
                updateToggleWhenClickAnywhere()
            })
            $(".penalSettings").click(function () {
                updateToggleWhenClickAnywhere()
            });
            function updateToggleWhenClickAnywhere() {
                $('.airview-schema-designer').removeClass('active');
                $(".schema-switch").find('.m_switch').removeClass('m_switch_color');
                $(".schema-switch").find('.m_switch_element').removeClass('m_switch_checked');
                $('.m_switch').find(".m_switch_check").removeAttr("checked");
            }
            //#endregion
        ...
        var handleDroppableOnTabWidget = function (vm, widgetIndex, compile, scope) {
            ...
            $(".new-template").find('.content-wrapper.draggableTabPanelBox').droppable({
                ...
                drop: function (event, ui) {
                    ...
                    // var tabInstance = $('#' + parentWidgetId).find('.tab-canvas.active .grid-stack'); //Change requirement
                    let currentParentWidgetId = $(this).parents('.grid-stack-item').attr('id');
                    var tabInstance = $(this).parents('.parent-widget').find('.tab-canvas.active .grid-stack')
                    if (tabInstance.length > 0) {
                        ...
                        if (panelType == mainPartialViewType) {
                            ...
                            if (!vm.dynamicPridefinedWidget.find(x=>x.coreType == $(ui.draggable).attr('core-data-type')).RenderInTab) {
                                toastrs.error("This widget can't be used in tab");
                                return false;
                            }
                            if (handleCheckPredefinedViewExistOrNot(vm, widgetIndex, scope, compile, panelType, $(ui.draggable).attr('core-data-type'))) {
                                toastrs.error("This widget already existed");
                        ...
                        let getPanelCodeBaseOnWidgetTypeElement = getWidgetSettings.find(x => x.type == panelType);
                        let getQueryBuilderElement = getWidgetSettings.find(x => x.type == "queryBuilder").code;
                        if (panelType == "widgetOfTab") {
                            toastrs.error("Tab Widget can't be used in tab.");
                            return false;
                        }
                        handleDragWidget(getPanelCodeBaseOnWidgetTypeElement.code, grids, $(".side-panel .tab-content .tab-pane > .toggle"), getPanelCodeBaseOnWidgetTypeElement["settings"], getPanelCodeBaseOnWidgetTypeElement["advanced_settings"], getQueryBuilderElement, $(".side-panel #queryBuilderSection"), compile, scope, vm, panelType, toastrs, currentParentWidgetId, { isRender: true, prevUniqueKey: null, nextUniqueKey: null, rendorUniqueKey: null, isDrilldownStatus: false, coreDataType: $(ui.draggable).attr('core-data-type'), title: getTitle });
                        scope.$apply();
        ...
        //#region check already predefined partial view is exist or not

        var handleCheckPredefinedViewExistOrNot = function (vm, widgetIndex, scope, compile, widgetType, widgetCoreType) {
            let getAllPredefinedPartialView = vm.dashboardAndReportComInformation.widgetList.filter(z=>z.widgetType == widgetType && z.isDeleted == false);
            if (getAllPredefinedPartialView) {
                let getIdx = getAllPredefinedPartialView.findIndex(x=>x.predefineWidget.coreType == widgetCoreType);
                if (getIdx > -1) {
                    return true;
                }
        ...
        var handleDrawWidgets = function (compile, scope, vm, callback, uiGridConstants, rootScope) {
            ...
            for (let index = 0; index < getLengthOfWidgetList; index++) {
                ...
                //}
                if (typeof vm.dashboardAndReportComInformation.widgetList[index].PWidgetID == "undefined") {
                    vm.dashboardAndReportComInformation.widgetList[index].PWidgetID = null;
                }
                if (typeof vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.shtrType == "undefined") {
                    vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.shtrType = shutterType.down;
                }

                if (!vm.dashboardAndReportComInformation.widgetList[index].isDeleted && vm.dashboardAndReportComInformation.widgetList[index].PWidgetID == null && vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.shtrType == currentShutterType) {
                    handleRenderWidget(element, addWidgetOfGridStackItem, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, queryBuilerEle, $(".side-panel #queryBuilderSection"), compile, scope, vm, index, vm.dashboardAndReportComInformation.widgetList[index].widgetType, uiGridConstants, rootScope, true, vm.dashboardAndReportComInformation.widgetList[index].PWidgetID);
                }
        ...
        var handleDroppablDbColumnForDefaultPage = function (event, ui, vm, widgetIndex, scope, compile) {
            ...
            //#region here is checking that content wrapper is empty or not if is not empty then should be empty otherwise already empty
            if ($(event.target).closest('.widget').find(".content-wrapper .center-icon").length > 0) {
                $(event.target).closest('.widget').find('.content-wrapper').empty();
            }
            //#endregion
            ...
            dbColumnSettingAndDataMemberProperty.fontColor = '#130101';
            ...
            dbColumnSettingAndDataMemberProperty.backGroundColor = '#FFF';
            ...
            //#region binding db columns setting in right side  and redraggable 
            handleBindDbColumnsSetting(vm, widgetIndex, scope, compile, '.' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID + '.default_settings .db-label-settings .toggle', ui.draggable.text(), getIndexOfCurrentDbColumnSettingDataMemberProperty, $(event.target).closest('.widget'), true);
        ...
        var handleBindDbColumnsSetting = function (vm, widgetIndex, scope, compile, parentElement, ColumnAccTitle, dbSettingIndex, widgetSelector, renderStatus) {
            ...
            $(dbColumnSetting).find('input.dbcolumnbackgroundcolor').attr('ng-model', 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + dbSettingIndex + '].backGroundColor');
        ...
        //#region get status colors from db set

        var handleGetStatusColors = function (vm, widgetIndex, scope, compile) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration.length > 0 && vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.length > 0) {
                $(vm.dashboardAndReportComInformation.widgetList[widgetIndex].data).each((idx, item) => {


                    if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration['statusColors'].findIndex(x=>x.statusName == item[vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[0].columnName]) < 0) {
                        let clrCode = vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.staClName == undefined ? handleRandomColor() : item[vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.staClName];
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration['statusColors'].push({ statusName: item[vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[0].columnName], fontColor: "#fff", backgroundColor: clrCode })
                    }
                });
        ...
        //#region draw data rows and columns form with default page Second layout

        var handleDrawDataRowsColumnsFormWithDefaultPageSecondLayout = function (vm, widgetIndex, scope, compile) {
            ...
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.isSingleOrMultiRow) {
                ...
                let setRowInit = 0;
                if (totalNumberOfRows > 100) {
                    gtoastr.error('execeeded record limit');
                    return false;
                }
                        ...
                        if (totalNumberOfRows > setRowInit) {
                            ...
                            for (var innerC = 0; innerC < vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration.length; innerC++) {
                                if (innerC == 0) {
                                    ...
                                    getcolrIdx = vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration['statusColors'].findIndex(x=>x.statusName == vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[setRowInit][vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[innerC].columnName]);
                                    divR += `<span  style=` + "font-size:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontSize' + "}}px" + ";" + "color:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontColor' + "}}" + ";" + "background-color:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].backGroundColor' + "}}" + ";" + "font-weight:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontBold' + "}}" + ";" + "font-family:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontFamily' + "}}" + ";" + "font-style:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontItalic' + "}}" + `>` + vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[setRowInit][vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[innerC].columnName] + `</span>`;
                                }
                                else {
                                    divR += `<i class=color1 style=` + "font-size:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontSize' + "}}px" + ";" + "color:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.statusColors[' + getcolrIdx + '].fontColor' + "}}" + ";" + "background-color:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.statusColors[' + getcolrIdx + '].backgroundColor' + "}}" + ";" + "font-weight:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontBold' + "}}" + ";" + "font-family:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontFamily' + "}}" + ";" + "font-style:{{" + 'vm.dashboardAndReportComInformation.widgetList[' + widgetIndex + '].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[' + innerC + '].fontItalic' + "}}" + `>` + vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[setRowInit][vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration[innerC].columnName] + `</i>`;
                                }
        ...
        //#region draw data rows and columns form with default page first layout
        ...
        var handleDroppablInputControlForDefaultPage = function (event, ui, vm, widgetIndex, scope, compile) {
            ...
            //#region binding db columns setting in right side  and redraggable 
            handleBindInputControlInAdvanceSetting(vm, widgetIndex, scope, compile, getIndexOfCurrentInputControlProperty, $(event.target).closest('.widget'));
        ...
        var handleDroppablImageControlForDefaultPage = function (event, ui, vm, widgetIndex, scope, compile) {
            ...
            //#region binding db columns setting in right side  and redraggable 
            handleBindImageControlInAdvanceSetting(vm, widgetIndex, scope, compile, getIndexOfCurrentImageControlProperty, $(event.target).closest('.widget'));
        ...
        var handleMaps = function (compile, scope, vm, WigetIndex, toasterStatus) {
            ...
            if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.mapleveltype == 'Region') {
                if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere == '()') {
                    GetQuery = "select TotalRecords, RecordValue, MapLatitude as Latitude, MapLongitude as Longitude, Region as Name, Region as Region from ( Select (COUNT(*)) as TotalRecords, (Region + ', ' + [State] + ', ' + Country) As RecordValue, Region from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ") a Group by Region, [State], Country) b Left outer join AD_Definations on b.Region = AD_Definations.DefinationName where AD_Definations.DefinationTypeId = 6";
                }
                else {
                    GetQuery = "select TotalRecords, RecordValue, MapLatitude as Latitude, MapLongitude as Longitude, Region as Name, Region as Region from ( Select (COUNT(*)) as TotalRecords, (Region + ', ' + [State] + ', ' + Country) As RecordValue, Region from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ") a Group by  Region, [State], Country) b Left outer join AD_Definations on b.Region = AD_Definations.DefinationName where AD_Definations.DefinationTypeId = 6";
                }
        ...
        var hanldeDefaultPage = function (compile, scope, vm, WigetIndex, toasterStatus) {
            ...
            if (GetQuery.length > 0) {
                //console.log(GetQuery);
                $('#' + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetID).find('.overlay').attr('style', 'display:block;');
                return handleGetDataFromDbForDefaultPage(WigetIndex, GetQuery, vm, toasterStatus).complete(function (result) {
        ...
        var handleQueryChangePageOrOrderBy = function (compile, scope, vm, uiGridConstants, WigetIndex, pageSize, pageNumber) {
            ...
            handleGetDataFromDbForTable(WigetIndex, makeQuery, vm, false).done(function (response) {
                ...
                if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].data.length > 0) {
                    handleGetDataToGevenValueForTable(vm, WigetIndex, null, null, true);
            ...
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.chartInitialization = new CanvasJS.Chart(vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.chartID,
                {
                    ...
                    axisX: {
                        ...
                        valueFormatString: vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput,
                        labelFormatter: function (e) {

                            return vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput == '' ? e.label : CanvasJS.formatNumber(e.label, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput);
                        }
                    ...
                    axisY: {
                        ...
                        valueFormatString: vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput,
        ...
        //#region render of the canvas charts for drilldown
        var handleChartRenderOfCanvasDrilldown = function (compile, scope, vm, renderWidgetIndex, dataWidgetIndex) {

            //#region data of chart
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.data = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].data;
            //#endregion
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.height = Number(vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].widgetConfiguration.styleInfo.widgetHeight) - 30;

            //#region settings

            //#region title settings
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.text = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.chartTitleName;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.fontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.fontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.fontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.fontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.fontFamily = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.fontFamily;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.fontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.fontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.title.fontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartTitleSettings.fontStyle;
            //#endregion

            //#region subtitle settings
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].text = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.chartSubtitleName;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].fontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.fontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].fontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.fontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].fontFamily = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.fontFamily;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].fontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.fontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.subtitles[0].fontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.chartSubTitleSettings.fontStyle;
            //#endregion

            //#region lengend settings

            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.fontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.fontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.fontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.fontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.fontFamily = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.fontFamily;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.fontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.fontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.fontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.fontStyle;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.verticalAlign = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.verticalAlign;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.legend.horizontalAlign = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.legendSettings.horizontalAlign;
            //#endregion

            //#region X-axis settings
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.title = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.title;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.titleFontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.titleFontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.titleFontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.titleFontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.titleFontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.titleFontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.titleFontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.titleFontStyle;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.labelFontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.labelFontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.labelFontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.labelFontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.labelFontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.labelFontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.labelFontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.labelFontStyle;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.prefix = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.prefix;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.suffix = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.suffix;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisX.valueFormatString = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput;
            //#endregion

            //#region Y-axis settings
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.title = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.title;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.titleFontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.titleFontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.titleFontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.titleFontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.titleFontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.titleFontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.titleFontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.titleFontStyle;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.labelFontColor = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.labelFontColor;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.labelFontSize = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.labelFontSize;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.labelFontWeight = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.labelFontWeight;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.labelFontStyle = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.labelFontStyle;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.prefix = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.prefix;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.suffix = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.suffix;
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.options.axisY.valueFormatString = vm.dashboardAndReportComInformation.widgetList[dataWidgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput;
            ...
            vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].chartConfigurations.chartInitialization.render();
        ...
        var handleChartRenderOfCanvas = function (compile, scope, vm, widgetIndex) {
            ...
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.chartInitialization.options.axisX.valueFormatString = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput;
            //#endregion
            ...
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.chartInitialization.options.axisY.valueFormatString = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput;
        ...
        var hanldeCheckChartCompanyType = function (compile, scope, vm, widgetIndex) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.keycode == "canvasCharts") {
                if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.isRender) {
                    let renderIdx = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.rendorUniqueKey)
                    handleChartRenderOfCanvasDrilldown(compile, scope, vm, renderIdx, widgetIndex);
        ...
        //#region set the click event for drilldown
        var handleSetClickEventForCharts = function (compile, scope, vm, widgetIndex) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.length > 0) {
                for (let index = 0; vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.length > index; index++) {
                    ...
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[index].click = handleDrillDownChart.bind(null, vm, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.rendorUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.isDrilldownStatus);
        ...
        var handleSetChartTypeOfCanvas = function (compile, scope, vm, widgetIndex) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.length > 0) {
                for (let index = 0; vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.length > index; index++) {
                    ...
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[index].xValueFormatString = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput;
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].data[index].yValueFormatString = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput;
                }
            }
        };
        //#endregion
        ...
        var handlereSizeAllWidget = function (compile, scope, vm, widgetIndex, uiGridConstants, $timeout) {
            switch (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetType) {
                case "widgetOfChart":
                    $timeout(function () {
                        if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.isRender) {
                            hanldeCheckChartCompanyType(compile, scope, vm, vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex);
        ...
        //#region set value top, left, width and right of widget for shutter up and down

        var handleSetValueTopLeftWidthAndRightOfWidgetShutterUpDown = function (getList) {
            let DefCalForWidthHeight = new jQuery.Deferred();
            let GridItems = xl_script.getGridItems();
            try {
                let getLengthOfDashboarAndReport = getList.widgetList.length;
                for (let i = 0; i < getLengthOfDashboarAndReport; i++) {
                    ...
                    if (getItem.widgetConfiguration.shtrType == currentShutterType && getItem.widgetType == "widgetOfTab") {
        ...
        var handleJsonForDatabase = function (dashboardAndReportJson, vm, toastrs, scope) {
            ...
            makeJsonOfDatabase.ModuleId = dashboardAndReportJsonRec.ModuleId;
            ...
            if (getLengthOfDashboarAndReport > 0) {
                ...
                for (let i = 0; i < getLengthOfDashboarAndReport; i++) {
                    ...
                    let getW = deleteChildTabWidget.findIndex(x=>x == getItem.widgetID);
                    if (getW > -1)
                        item.isDeleted = true;
                    if (getItem.widgetType == "widgetOfChart") {
                        ...
                        item.widgetType = getItem.widgetType;
                        item.widgetConfiguration = JSON.stringify(getItem.widgetConfiguration);
                        item.widgetItemConfiguration = JSON.stringify(getItem.mapConfigurations);
                        makeJsonOfDatabase.widgetList.push(item);
                    }
                        ...
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        if (getItem.widgetConfiguration.shtrType == currentShutterType)
                            getItem.widgetConfiguration.TabsInfo = xl_script.getTabsWidgetsInfo(getItem.widgetID);
                        // console.log(getItem.widgetConfiguration.TabsInfo);
                        item.widgetConfiguration = JSON.stringify(getItem.widgetConfiguration);
                        makeJsonOfDatabase.widgetList.push(item);
                    }
                    ...
                    else if (getItem.widgetType == 'widgetOfFormDotIo') {
                        item.widgetID = getItem.widgetID;
                        item.widgetName = getItem.widgetName;
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        getItem.formDotIoConfigurations.components = getItem.formBuilder.schema;
                        item.widgetItemConfiguration = JSON.stringify(getItem.formDotIoConfigurations);
                        item.widgetConfiguration = JSON.stringify(getItem.widgetConfiguration);
                        makeJsonOfDatabase.widgetList.push(item);
                        if (getItem.isDeleted) {
                            handleRemoveEntireForm(vm, i)
                        }
                    }
                    else if (getItem.widgetType == 'widgetOfPredefined') {
                        item.widgetID = getItem.widgetID;
                        item.widgetName = getItem.widgetName;
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        item.widgetItemConfiguration = JSON.stringify(getItem.predefineWidget);
                        item.widgetConfiguration = JSON.stringify(getItem.widgetConfiguration);
                        makeJsonOfDatabase.widgetList.push(item);
                    }
            ...
            $http({
                method: 'POST',
                url: '/BusinessIntelligence/DashboardNReport/PostTemplate',
        ...
        var handleJsonForFrontend = function (compile, scope, vm, uiGridConstants, DashboardAndReportJsonFromDb, rootScope) {
            ...
            makeJsonForFrontend.centralizeDataSourceNDatabaseInfo = {};
            makeJsonForFrontend.centralizeDataSourceNDatabaseGroupBysource = [];
            ...
            if (getLengthOfDashboarAndReport > 0) {
                for (let i = 0; i < getLengthOfDashboarAndReport; i++) {
                    ...
                    if (getItem.widgetType == "widgetOfChart") {
                        ...
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        item.mapConfigurations = JSON.parse(getItem.widgetItemConfiguration);
                        item.widgetConfiguration = JSON.parse(getItem.widgetConfiguration);
                        item.data = [];
                        item.mapColumnLatLng = [];
                        makeJsonForFrontend.widgetList.push(item);
                    }
                    else if (getItem.widgetType == "widgetOfDefault") {
                        item.widgetID = getItem.widgetID;
                        ...
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        item.formDotIoConfigurations = JSON.parse(getItem.widgetItemConfiguration);
                        item.widgetConfiguration = JSON.parse(getItem.widgetConfiguration);
                        item['formBuilder'] = {};
                        item['builderNFormStatus'] = false;
                        item['builderNFormIcon'] = "fa fa-building";
                        item['deletedComponent'] = [];
                        ...
                        item.isDeleted = getItem.isDeleted;
                        item.widgetType = getItem.widgetType;
                        item.predefineWidget = JSON.parse(getItem.widgetItemConfiguration);
                        item.widgetConfiguration = JSON.parse(getItem.widgetConfiguration);
                        makeJsonForFrontend.widgetList.push(item);
                    }
            ...
            // console.log(makeJsonForFrontend);
            //   getViewsOfDb(vm);
            //   handleDocumentPath(vm, scope, compile, true, currentIndex);
        ...
        //#region integrated module json
        var handleIntegratedModuleJsonForFrontend = function (compile, scope, vm, uiGridConstants, DashboardAndReportJsonFromDb, rootScope) {
            let makeJsonForFrontend = {};
            makeJsonForFrontend.pageID = DashboardAndReportJsonFromDb.pageID;
            makeJsonForFrontend.templateTitle = DashboardAndReportJsonFromDb.templateTitle;
            makeJsonForFrontend.templateType = DashboardAndReportJsonFromDb.templateType;
            ...
            makeJsonForFrontend.IsActive = DashboardAndReportJsonFromDb.IsActive;
            makeJsonForFrontend.publicTmp = DashboardAndReportJsonFromDb.publicTmp;
            makeJsonForFrontend.ModuleId = moduleInformation.ModuleTypeId
            if (DashboardAndReportJsonFromDb.IsActive) {
        ...
        //#region relace unique id  

        var handleReplaceUniqueId = function (DashboardAndReportJsonFromDb, oldUni, newUni) {
            let getLengthOfDashboarAndReport = DashboardAndReportJsonFromDb.widgetList.length;
            let regex = new RegExp(oldUni, "g");
            if (getLengthOfDashboarAndReport > 0) {
                for (let i = 0; i < getLengthOfDashboarAndReport; i++) {
                    let getItem = DashboardAndReportJsonFromDb.widgetList[i];
                    if (getItem.PWidgetID == oldUni) {
                        getItem.PWidgetID = newUni;
                    }
                    if (getItem.widgetConfiguration)
                        getItem.widgetConfiguration = getItem.widgetConfiguration.replace(regex, newUni);
                    if (getItem.widgetItemConfiguration)
                        getItem.widgetItemConfiguration = getItem.widgetItemConfiguration.replace(regex, newUni);
        ...
        //#region make json of other integrated module for frontend
        var handleReplaceUniIdForIntregratedModule = function (compile, scope, vm, uiGridConstants, DashboardAndReportJsonFromDb, rootScope) {
            let replaceUniOldNew = new jQuery.Deferred();
            try {


                DashboardAndReportJsonFromDb.pageID = handleUniquekey(6);
                DashboardAndReportJsonFromDb.TemplateID = null;
                let getLengthOfDashboarAndReport = DashboardAndReportJsonFromDb.widgetList.length;
                if (getLengthOfDashboarAndReport > 0) {
                    for (let i = 0; i < getLengthOfDashboarAndReport; i++) {
                        let getItem = DashboardAndReportJsonFromDb.widgetList[i];
                        let oldUni = getItem.widgetID;
                        let newUni = handleUniquekey(6);
                        getItem.widgetID = newUni;
                        getItem.TemplateNodeID = null;

                        handleReplaceUniqueId(DashboardAndReportJsonFromDb, oldUni, newUni);

                    }
                }
                replaceUniOldNew.resolve(DashboardAndReportJsonFromDb);
            } catch (e) {
                replaceUniOldNew.reject();
            }

            return replaceUniOldNew.promise();
        ...
        var handleRenderClonedWidget = function (compile, scope, vm, callback, uiGridConstants, rootScope) {
            ...
            var queryBuilerEle = getWidgetSettings.find(x => x.type == "queryBuilder").code;
            if (!vm.dashboardAndReportComInformation.widgetList[index].isDeleted) {
                handleRenderWidget(element, parentElement, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, queryBuilerEle, $(".side-panel #queryBuilderSection"), compile, scope, vm, index, vm.dashboardAndReportComInformation.widgetList[index].widgetType, uiGridConstants, rootScope, true, vm.dashboardAndReportComInformation.widgetList[index].PWidgetID);
            }
            callback();
        };
        //#endregion end code
        ...
        var handleGetQueryResult = function (queryBuild, vm, widgetIndex) {
            if (vm.getDataBaseOnId)
                queryBuild = queryBuild.replace(/{EMSRefId}/g, vm.getDataBaseOnId);
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].finalQueryRef = queryBuild
            return $.ajax({
                type: "POST",
        ...
        var handleGetDataFromDbForMap = function (widgetIndex, QueryBuild, vm, toasterStatus) {
            return handleGetQueryResult(QueryBuild, vm, widgetIndex).success(function (result) {
                if (result.status) {
        ...
        var handleGetDataFromDbForTable = function (widgetIndex, QueryBuild, vm, toasterStatus) {
            return handleGetQueryResult(QueryBuild, vm, widgetIndex).success(function (result) {
                if (result.status) {
                    ...
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].data = getData;
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data = $.extend(true, [], getData);
                    if (toasterStatus)
                        toastrs.success("Query has been executed");
                }
                else {
        ...
        var handleLineChart = function (widgetIndex, vm, data) {
            let makeLineChart = {
                ...
                xValueFormatString: vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput,
                yValueFormatString: vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput,
                click: handleDrillDownChart.bind(null, vm, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.rendorUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey, vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.isDrilldownStatus),
                dataPoints: []
            };
            $(data).each(function (i) {
                makeLineChart.dataPoints.push({
                    y: parseFloat(data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.yAxis]), label: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], DDCDO: data[i]
                });
            });
        ...
        var handlePieChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                makeLineChart.dataPoints.push({ y: parseFloat(data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.yAxis]), label: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], DDCDO: data[i] });
            });
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.push(makeLineChart);
        ...
        var handleMakeXAndYDataFormatFromDbWithoutGroup = function (data, vm, widgetIndex, xIndex, yIndex, getformatForStackOnRunTime) {
            ...
            for (let dataIndex = 0; dataIndex < data.length; dataIndex++) {
                ...
                if (getItemOnSeries) {
                    ...
                    getItemOnSeries['DDCDO'] = data[dataIndex];
                }
        ...
        var handleDoughnutChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                makeDoughnutChart.dataPoints.push({ y: parseFloat(data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.yAxis]), label: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], DDCDO: data[i] });
            });
        ...
        var handleRangeBarChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                ...
                s = s + increament;
                makeLineChart.dataPoints.push({
                    x: s, y: [keepValueOfS, s], label: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], DDCDO: data[i]
                });
            });
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.push(makeLineChart);
        ...
        var handleCandleStickChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                ...
                makeLineChart.dataPoints.push({ x: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis] + (Math.floor((Math.random() * 20) + 1)), y: [open, max, min, (Math.floor((Math.random() * 100) + 1))], DDCDO: data[i] });
            });
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.push(makeLineChart);
        ...
        var handleScatterChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                makeLineChart.dataPoints.push({ x: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], y: parseFloat(data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.yAxis]), DDCDO: data[i] });
            });
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.push(makeLineChart);
        ...
        var handleErrorLineChart = function (widgetIndex, vm, data) {
            ...
            $(data).each(function (i) {
                ...
                makeLineChart.dataPoints.push({ y: [min, max], label: data[i][vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.Advancesettings.xAxis], DDCDO: data[i] });
            });
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].data.push(makeLineChart);
            //render orignal y points
        ...
        //#region make drilldown chart

        var handleDrillDownChart = function (vm, rendorUniqueKey, prevUniqueKey, nextUniqueKey, isDrilldownStatus, event) {

            let renderIdx = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == rendorUniqueKey);
            if (nextUniqueKey == null) {


                if (vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex].chartConfigurations.drilldownParams.nextUniqueKey == null) {
                    return false;
                }
                nextUniqueKey = vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex].chartConfigurations.drilldownParams.nextUniqueKey

            }
            let toastrStatus = false;
            let getValue = event.dataPoint.label;

            let NextWidgetIdx = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == nextUniqueKey)
            let GetQuery = vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].widgetConfiguration.sqlQueryBuild;
            $('#' + vm.dashboardAndReportComInformation.widgetList[renderIdx].widgetID).find('.overlay').attr('style', 'display:block;');
            GetQuery = GetQuery.replace(/Drilldown/g, getValue)
            handleGetDataFromDbForCharts(NextWidgetIdx, GetQuery, vm, toastrStatus, gscope, gcompile).done(function (res) {
                if (res.status) {
                    if (toastrStatus) {
                        toastrs.success("Query has been executed");
                    }
                    handleFillTreeviewForChartsDrilldown(vm, renderIdx, NextWidgetIdx, gscope, gcompile);
                    // handleChartRenderOfCanvasDrilldown(null, null, vm, renderIdx, NextWidgetIdx);
                    vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex = NextWidgetIdx;

                    //  $('#'+nextUniqueKey).addClass("change-settings").siblings().removeClass("change-settings");
                    $.when($(".querybuilder-wrapper , .widget-settings,.default_advance_settings ").fadeOut()).done(function () {
                        $("." + nextUniqueKey).fadeIn();
                    });
                    if (vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].loading) {
                        handleCheckCentralizeDatabaseExistOrNot(vm, NextWidgetIdx, gscope, gcompile);
                        vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].loading = false;
                        $timeout(function () {
                            handleRenderEdgesWhenTemplateIsReloadingFromDB(vm, NextWidgetIdx, gscope, gcompile, vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].widgetID);

                        }, 3000);

                    }
                    currentIndex = NextWidgetIdx;
                    handleInitializationOfWhereClauseWhenSelectaDataSet(vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].widgetConfiguration.whereClauseConfiguration.whereClauseJsonWithRuleAndGroup, gscope, gcompile, grootScope, vm, NextWidgetIdx);
                    handleAddColumnsOrRemoveColumnInWhereCluase(vm, NextWidgetIdx, gscope, gcompile, vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].SelectedTablesColumnName);

                    //debugger
                    // handleFillTreeviewFilterationOfAllWidgets(vm, WigetIndex, scope, compile);

                    //hanldeCheckChartCompanyType(compile, scope, vm, WigetIndex);
                    $('#' + vm.dashboardAndReportComInformation.widgetList[renderIdx].widgetID).find('.overlay').attr('style', 'display:none;');
                }
                else {
                    vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex = NextWidgetIdx;
                    vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].data = [];
                    ...
                    handleInitializationOfWhereClauseWhenSelectaDataSet(vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].widgetConfiguration.whereClauseConfiguration.whereClauseJsonWithRuleAndGroup, gscope, gcompile, grootScope, vm, NextWidgetIdx);
                    handleAddColumnsOrRemoveColumnInWhereCluase(vm, NextWidgetIdx, gscope, gcompile, vm.dashboardAndReportComInformation.widgetList[NextWidgetIdx].SelectedTablesColumnName);
                    hanldeCheckChartCompanyType(gcompile, gscope, vm, NextWidgetIdx);
                    toastrs.error("Data has not been found");
                    $('#' + vm.dashboardAndReportComInformation.widgetList[renderIdx].widgetID).find('.overlay').attr('style', 'display:none;');
                }
            ...
            if (GetQuery.length > 0) {
                ...
                handleGetDataFromDbForTable(index, GetQuery, vm, toastrStatus).done(function (response) {
                    if (vm.dashboardAndReportComInformation.widgetList[index].uiGridConfiguration.paginationStatus) {
                        ...
                        vm.dashboardAndReportComInformation.widgetList[index].tempData.data = $.extend(true, [], vm.dashboardAndReportComInformation.widgetList[index].data);
                        handleGetDataToGevenValueForTable(vm, index, null, null, false);
                        handleFillTreeviewFilterationOfAllWidgets(vm, index, scope, compile);
        ...
        var handleSelectedColumnOfQueryBuilder = function (QueryBuilderUniqueKey, widgetIndex, vm) {
            if ($('.' + QueryBuilderUniqueKey + ' .selected-rows').length > 0) {
        ...
        var handleRemoveColumnFromSelectedColumnListInMultiSchemaDesigner = function (vm, widgetIndex, scope, compile, dataset, columnsList) {
            ...
            if (getLengthOfColumnList > 0) {
                for (let idx = 0; idx < getLengthOfColumnList; idx++) {
                    ...
                    let getColumnIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == getItem['value'] && x.value['label'] == getItem['label']);
                    if (getColumnIndex > -1) {
                        ...
                        handleRemoveColumnInTableForSchemaDesignerCanvas(vm, widgetIndex, getItem['value'], getItem['label'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                    }

                    //  handleDeleteViewAndItsColumnsNameForSchemaDesigner(vm, widgetIndex, { label: getItem.label, value: dataset }, scope, compile);
                }
                handleRemoveTableForSchemaDesignerOnCanvas(vm, widgetIndex, dataset, vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                handleAddColumnsOrRemoveColumnInWhereCluase(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName);
            }
        };
        ...
        //#region fill treeview for filter the drilldown charts
        var handleFillTreeviewForChartsDrilldown = function (vm, renderWidgetIndex, widgetIndex, scope, compile) {
            var data = JSON.parse(vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data);
            if (data.length > 0) {
                //for temp logic
                data = data.slice(0, 10);
                var getColumnName = data[0];
                vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].columnValueForFilteration = [];
                for (var key in getColumnName) {
                    ...
                    if (status) {
                        ...
                        vm.dashboardAndReportComInformation.widgetList[renderWidgetIndex].columnValueForFilteration.push(itemTreeview);
                    }
                }
        ...
        //#region filter for datatable

        //#region fill treeview for datatable
        var handleFillTreeviewForTable = function (vm, widgetIndex, scope, compile) {
            var data = vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data;
            if (data.length > 0) {
                //for temp logic
                data = data.slice(0, 10);
                var getColumnName = data[0];
        ...
        //#region get data to given value for Table
        var handleGetDataToGevenValueForTable = function (vm, widgetIndex, scope, compile, status) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data) {
                let dataData = vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data;
                ...
                if (Object.keys(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.FilterOnKeyValue).length) {
                    ...
                    if (status)
                        vm.renderTableData(widgetIndex)
                }
                else {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].data = $.extend(true, [], vm.dashboardAndReportComInformation.widgetList[widgetIndex].tempData.data);
                    if (status)
                ...
                for (var key in getColumnName) {
                    ...
                    if (key != "Name" && key != "TotalRecords" && key != "Latitude" && key != "Longitude" && key != "RecordValue") {
                        if (historyofCols.length > 0) {
                            let getIndex = historyofCols.findIndex(x => x.columnaliasname == key && (x.currentDataType == "select" || x.currentDataType == "nvarchar"));
        ...
        var handleFillTreeviewFilterationOfAllWidgets = function (vm, widgetIndex, scope, compile) {
            switch (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetType) {
                ...
                case 'widgetOfTable':
                    // code start
                    handleFillTreeviewForTable(vm, widgetIndex);
                    // code end
                    break;
                default:
            }
        ...
        var handleGetDataToGivenValueForAllWidgets = function (vm, widgetIndex, scope, compile) {
            switch (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetType) {
                case 'widgetOfChart':
                    ...
                    break;
                case 'widgetOfTable':
                    handleGetDataToGevenValueForTable(vm, widgetIndex, scope, compile, true);
                    break;
                case 'widgetOfMap':
        ...
        var handleCheckWidgetType = function (compile, scope, vm, uiGridConstants, WigetIndex, toastrs) {
            switch (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetType) {
                ...
                case 'widgetOfDefault':
                    ...
                    handleResetDbColumnSettingForDefaultPage(vm, WigetIndex, scope, compile);
                    break;
                default:
            }
        ...
        var handleAssignXaxisYaxisSeries = function (vm, WigetIndex) {
            vm.dashboardAndReportComInformation.widgetList[WigetIndex].multiSeriesXaixSelect = vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.historyOfQueryBuilder.filter(x=>x.duplicate == false).map(xasixColumn => {
                let xaxisColumnObj = {};
            ...
            vm.dashboardAndReportComInformation.widgetList[WigetIndex].multiSeriesYaixSelect = vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.historyOfQueryBuilder.filter(x=>x.duplicate == false).filter(x => (x.currentDataType == "numeric" || x.currentDataType == "float" || x.currentDataType == "real" || x.currentDataType == "int" || x.currentDataType == "decimal")).map(yasixColumn => {
                let yaxisColumnObj = {};
        ...
        //#region Assign column name to status colr name
        var handleAssignColumnNameStatusName = function (vm, WigetIndex) {
            vm.dashboardAndReportComInformation.widgetList[WigetIndex].stClrColNames = vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.historyOfQueryBuilder.filter(x=>x.duplicate == false).map(xasixColumn => {
                let statusClrColumnObj = {};
                statusClrColumnObj['statusClrColName'] = xasixColumn.columnaliasname;
                return statusClrColumnObj;
            });
        ...
        //#region Assign column name to lat and lng for map widget 
        var handleAssignColumnNameLatLngForMap = function (vm, WigetIndex) {
            vm.dashboardAndReportComInformation.widgetList[WigetIndex].mapColumnLatLng = vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.historyOfQueryBuilder.filter(x=>x.duplicate == false).map(xasixColumn => {
                let latLngObj = {};
                latLngObj['latLngName'] = xasixColumn.columnaliasname;
                return latLngObj;
            });
        ...
        var handleLoadColumnsInSettingsOfDefaultPage = function (vm, widgetIndex, scope, compile) {
            ...
            if (getQueryBuilderHistory.length > 0) {
                ...
                for (let i = 0; i < getQueryBuilderHistory.length; i++) {
                    ...
                    $(uiColumnInDefaultPage).find('.draggable_element').attr('data-member-name', getQueryBuilderHistory[i].columnaliasname);
        ...
        //#region reset the db column setting for default page widget
        var handleResetDbColumnSettingForDefaultPage = function (vm, widgetIndex, scope, compile) {
            $('.' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID + '.default_settings .db-label-settings .toggle').empty();
            $('#' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID + ' .grid-area-dynamic-column').empty();
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dbColumnsSettingsDataMemberPropertiesConfiguration = [];
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration['statusColors'] = [];
        ...
        var handleAssignValueOfDefaultPage = function (vm, widgetIndex, data) {
            for (var key in data) {
                ...
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.dataParams[key] = data[key];
            }
        ...
        var handleSelectTablesNameWhenDoNotSelectAtleastOneJoin = function (tableList) {
            ...
            if (getTablesNameLength > 0) {
                for (let idx = 0; idx < getTablesNameLength;) {
                    ...
                    selectTablesName += '[' + tableList[idx]['dataSourceName'] + '].' + '[' + tableList[idx]['remoteDatabase'] + '].' + '[' + tableList[idx]['Schemas'] + '].' + '[' + tableList[idx]['table'] + ']' + " AS " + tableList[idx]['table'];
                    idx++;
        ...
        var handleExecuteQueryForMultiDataset = function (vm, WigetIndex, compile, scope, uiGridConstants, toastrs, queryExeStatus) {
            ...
            if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetType == "widgetOfDefault") {
                ...
                handleAssignColumnNameStatusName(vm, WigetIndex);
            }
            if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetType == "widgetOfMap") {

                handleAssignColumnNameLatLngForMap(vm, WigetIndex);
            }
        ...
        var handleRenderSelectedColumnWithMultiSchemaDesignerUsingJson = function (vm, widgetIndex, viewName, columnName, columnDataType, scope, compile, aggriFunc, grp, ordrby) {
            ...
            if ($('.' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find(".selected-rows .tg-row#" + uniqueId).length < 1) {
                ...
                $(newRow).find('.tbl-group').prop('checked', grp)
                // newRow = compile(newRow)(scope);
        ...
        var handleInitializationOfWhereClauseWhenSelectaDataSet = function (datat1, scope, compile, rootScope, vm, widgetIndex) {
            ...
            function computed(group) {
                ...
                for (var str = "(", i = 0; i < group.rules.length; i++) {
                    ...
                    if (group.rules[i].condition == 'BETWEEN') {
                    ...
                    else if (group.rules[i].condition == 'Drilldown') {
                        let splitBaseOnDotOperator = group.rules[i].field.split('.');
                        let fieldFormat = splitBaseOnDotOperator[0] + ".[" + splitBaseOnDotOperator[1] + "]"
                        group.rules[i].data = "";
                        group.rules[i].databetween = "";
                        str += group.rules[i].group ?
                            computed(group.rules[i].group) :
                            " " + fieldFormat + " " + htmlEntities("=" + "'Drilldown'") + " ";
                    }
                    else if (group.rules[i].condition == '{EMSRefId}') {
                        let splitBaseOnDotOperator = group.rules[i].field.split('.');
                        let fieldFormat = splitBaseOnDotOperator[0] + ".[" + splitBaseOnDotOperator[1] + "]"
                        group.rules[i].data = "";
                        group.rules[i].databetween = "";
                        str += group.rules[i].group ?
                            computed(group.rules[i].group) :
                            " " + fieldFormat + " " + htmlEntities("=" + "'{EMSRefId}'") + " ";
                    }
                    else if (group.rules[i].condition == 'LIKE' || group.rules[i].condition == 'NOT LIKE') {
                        let splitBaseOnDotOperator = group.rules[i].field.split('.');
                        let fieldFormat = splitBaseOnDotOperator[0] + ".[" + splitBaseOnDotOperator[1] + "]"
        ...
        //#region get columns list from widget datasource for remote

        var handleGetColumnsListFromWidgetDatasourceRemote = function (vm, widgetIndex, ivhNode, scope, compile) {

            let getDataSourceIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns.findIndex(x=>x['label'] == ivhNode['dataSourceName']);
            let getDbIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns[getDataSourceIndex]['children'].findIndex(x=>x['label'] == ivhNode['remoteDatabase']);
            let getDatabase = vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns[getDataSourceIndex]['children'][getDbIndex]['children'];
            let getTableAndColumns = undefined;
            getDatabase = getDatabase.find(x=>x.label == ivhNode['TableType'])
            if (getDatabase)
                getTableAndColumns = getDatabase['children'].find(x=>x['label'] == ivhNode['value'])['children'];
            //if (getDatabase && !getTableAndColumns) {
            //    getTableAndColumns = getDatabase['children'].find(x=>x['label'] == ivhNode['value'])['children'];
            //}
            return getTableAndColumns;

        }
        //#endregion

        //#region removed table from canvas, removed all columns from where clause

        var handleRemovedColumnsFromWhereClauseNTableFromCanvasRemote = function (vm, widgetIndex, ivhNode, scope, compile) {
            let getTableIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == ivhNode['value'] && x['value']['selCSta'] == true);
            if (getTableIndex < 0) {
                let getTableAndColumns = handleGetColumnsListFromWidgetDatasourceRemote(vm, widgetIndex, ivhNode, scope, compile);
                let getselectedViewsNTablesIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.findIndex(x=>x['table'] == ivhNode['value']);
                if (getselectedViewsNTablesIndex > -1) {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.splice(getselectedViewsNTablesIndex, 1);
                }
                //handleRemoveTableForSchemaDesignerOnCanvas(vm, widgetIndex, ivhNode['value'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                handleRemoveColumnFromSelectedColumnListInMultiSchemaDesigner(vm, widgetIndex, scope, compile, ivhNode['value'], getTableAndColumns);
            }
        ...
        //#region add where clause and table on canvas when add first column from a table
        var handleInitWhereClauseNAddTableRemote = function (vm, widgetIndex, ivhNode, scope, compile) {
            let getTableIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == ivhNode['value']);
            if (getTableIndex < 0) {
                handleInitializationOfWhereClauseWhenSelectaDataSet(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.whereClauseConfiguration.whereClauseJsonWithRuleAndGroup, scope, compile, null, vm, widgetIndex);
                handleDrawTableForSchemaDesigner(vm, widgetIndex, ivhNode['value'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);

                let getTableAndColumns = handleGetColumnsListFromWidgetDatasourceRemote(vm, widgetIndex, ivhNode, scope, compile);
                for (let i = 0; i < getTableAndColumns.length; i++) {
                    let columnItem = getTableAndColumns[i];
                    let dataType = handleGetcolumnTypeWhenRenderInBelowDatdaset(columnItem.ColumnDataType);
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName.push({ name: columnItem['value'] + "." + columnItem.ColumnName, DataType: dataType, DisplayType: columnItem.IsSelectType });
                    let schemaDesignerOnKeyValue = {};
                    schemaDesignerOnKeyValue['key'] = columnItem['value'];
                    schemaDesignerOnKeyValue['value'] = {};
                    schemaDesignerOnKeyValue['value']['label'] = columnItem['label'];
                    schemaDesignerOnKeyValue['value']['dataType'] = columnItem['dataType'];
                    schemaDesignerOnKeyValue['value']['selCSta'] = false;
                    if (ivhNode['label'] == columnItem['label'])
                        schemaDesignerOnKeyValue['value']['selCSta'] = true;

                    let getColumnIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == columnItem['value'] && x.value['label'] == columnItem['label']);
                    if (getColumnIndex < 0) {
                        ...
                        handleDrawColumnInTableForSchemaDesigner(vm, widgetIndex, columnItem['value'], columnItem['label'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);

                    }

                }

                let viewHistory = { dataSourceName: ivhNode['dataSourceName'], remoteDatabase: ivhNode['remoteDatabase'], Schemas: ivhNode['Schemas'], table: ivhNode['value'] }
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.push(viewHistory);
                handleAddColumnsOrRemoveColumnInWhereCluase(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName);
            }
        ...
        //#region add where clause and table on canvas when add first column from a table for remote subquery
        var handleInitWhereClauseNAddTableRemoteSubquery = function (vm, widgetIndex, ivhNode, scope, compile) {
            let getTableIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == ivhNode['value']);
            if (getTableIndex < 0) {
                handleInitializationOfWhereClauseWhenSelectaDataSet(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].whereClauseJsonWithRuleAndGroup, scope, compile, null, vm, widgetIndex);
                handleDrawTableForSchemaDesigner(vm, widgetIndex, ivhNode['value'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                ...
                let viewHistory = { dataSourceName: ivhNode['dataSourceName'], remoteDatabase: ivhNode['remoteDatabase'], Schemas: ivhNode['Schemas'], table: ivhNode['value'] }
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].multiSelectedViews.push(viewHistory);
                handleAddColumnsOrRemoveColumnInWhereCluase(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName);
            }
        ...
        var handleAddColumnOnlyForSchemaDesigner = function (vm, widgetIndex, ivhNode, scope, compile) {
            if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueryStatus) {
                handleInitWhereClauseNAddTableRemote(vm, widgetIndex, ivhNode, scope, compile);
            }
            else {
                handleInitWhereClauseNAddTableRemoteSubquery(vm, widgetIndex, ivhNode, scope, compile);
            }
            ...
            if (getColumnIndex > -1) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue[getColumnIndex]['value']['selCSta'] = true;;
        ...
        var handleDeleteViewAndItsColumnsNameForSchemaDesigner = function (vm, widgetIndex, ivhNode, scope, compile) {
            if (typeof ivhNode.children != "undefined") {
                ...
                let getColumnIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == ivhNode['value'] && x.value['label'] == ivhNode['label']);
                if (getColumnIndex > -1) {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue[getColumnIndex]['value']['selCSta'] = false;;
                    //handleRemoveColumnInTableForSchemaDesignerCanvas(vm, widgetIndex, ivhNode['value'], ivhNode['label'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                ...
                handleRemovedColumnsFromWhereClauseNTableFromCanvasRemote(vm, widgetIndex, ivhNode, scope, compile)
                //console.log(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue);
            }
        ...
        var handleMakeJoinFromJoinDetailsObject = function (vm, widgetIndex, scope, compile) {
            ...
            if (getLengthOfJoin > 0) {
                for (let idx = 0; idx < getLengthOfJoin; idx++) {
                    let getItem = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinDetailsKeyValue[idx];
                    uni = "";
                    let getSource = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.find(x=>x.table == getItem.source.key.split('-')[0]);
                    let getTarget = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.find(x=>x.table == getItem.target.key.split('-')[0]);
                    let makeSourceRemoteDataSource = "";
                    let makeTargetRemoteDataSource = "";
                    if (getSource)
                        makeSourceRemoteDataSource = '[' + getSource['dataSourceName'] + '].[' + getSource['remoteDatabase'] + '].[' + getSource['Schemas'] + '].[' + getSource['table'] + ']';
                    if (getTarget) {
                        if (getSource['table'] == getTarget['table']) {
                            uni = "1";
                        }
                        makeTargetRemoteDataSource = '[' + getTarget['dataSourceName'] + '].[' + getTarget['remoteDatabase'] + '].[' + getTarget['Schemas'] + '].[' + getTarget['table'] + ']'
                    }

                    if (idx == 0)
                        makeJoins += makeSourceRemoteDataSource + " AS " + getItem.source.key.split('-')[0] + " " + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinTypeWithForeignKeyReference[idx].joinType + " JOIN " + makeTargetRemoteDataSource + " AS " + getItem.target.key.split('-')[0] + uni + " ON ";
                    else
                        makeJoins += " " + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinTypeWithForeignKeyReference[idx].joinType + " JOIN " + makeTargetRemoteDataSource + " AS " + getItem.target.key.split('-')[0] + uni + " ON ";

                    for (let idxColumn = 0; idxColumn < getItem.source.value.length;) {
                        makeJoins += getItem.source.value[idxColumn].tableName + "." + "[" + getItem.source.value[idxColumn].columnName + "]" + "=" + getItem.target.value[idxColumn].tableName + uni + "." + "[" + getItem.target.value[idxColumn].columnName + "]";
                        idxColumn++;
        ...
        var checkViewOrColumnForSchemaDesigner = function (vm, widgetIndex, viewOrColumnName) {
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.findIndex(x=>x['table'] == viewOrColumnName) > -1) {
                return true;
            }
            else {
                return false;
        ...
        var handleInitializationOfMxEvent = function (vm, widgetIndex, scope, compile) {
            ...
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.connectionHandler.addListener(mxEvent.CONNECT, function (sender, evt) {
                if (evt.properties.cell.source && evt.properties.cell.target)
            ...
            //#region remove edges and cells

            vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.addListener(mxEvent.REMOVE_CELLS, function (sender, evt) {

                var getCell = evt.getProperty('cells');
                if (getCell.length > 1 && edgeDelStatus) {
                    if (getCell[1]['edge']) {
                        let sourceColumnName = getCell[1]['source']['value'];
                        let sourceTableNameOrviewName = getCell[1]['source']['id'].substr(0, getCell[1]['source']['id'].length - (sourceColumnName.length + 7));
                        let targetColumnName = getCell[1]['target']['value'];
                        let targetTableNameOrviewName = getCell[1]['target']['id'].substr(0, getCell[1]['target']['id'].length - (targetColumnName.length + 7));
                        handleDeleteJoinKeyValue(vm, widgetIndex, scope, compile, sourceColumnName, sourceTableNameOrviewName, targetColumnName, targetTableNameOrviewName);
            ...
            //#region dynamic event with type of any tag, also register own events

            addDynamicEventWithTag(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxEditor, $('.' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID + ' .select-table'), 'delete', 'Delete', null, false, 'fa fa-times', true, 'custom-btn color11 delete-edges-vertices');
            //#endregion
        };

        //#endregion

        //#region remove join key value information from json

        var handleDeleteJoinKeyValue = function (vm, widgetIndex, scope, compile, sourceColumnName, sourceTableNameOrviewName, targetColumnName, targetTableNameOrviewName) {
            let getJoinKeyValueIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinDetailsKeyValue.findIndex(x => x.source.key == sourceTableNameOrviewName + '-' + targetTableNameOrviewName && x.target.key == targetTableNameOrviewName + '-' + sourceTableNameOrviewName);
            if (getJoinKeyValueIndex > -1) {
                let getItem = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinDetailsKeyValue[getJoinKeyValueIndex]
                for (let i = 0; getItem.source.value.length; i++) {

                    if (getItem.source.value[i]['columnName'] == sourceColumnName && getItem.target.value[i]['columnName'] == targetColumnName) {

                        getItem.source.value.splice(i, 1);
                        getItem.target.value.splice(i, 1);
                        if (getItem.source.value.length == 0 && getItem.target.value.length == 0)
                            vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.joinDetailsKeyValue.splice(getJoinKeyValueIndex, 1)
                        break;
        ...
        //#region add dynamic event for any tag
        var addDynamicEventWithTag = function (vm, widgetIndex, scope, compile, editor, toolbar, action, label, image, isTransparent, className, fafaIcon, buttonClass) {
            var button = airviewXcelerateAppSettings.getCreateButton(image, fafaIcon, className, label, buttonClass);
            button['vm'] = vm;
            button['widgetIndex'] = widgetIndex;
            button['scope'] = scope;
            button['compile'] = compile;
            mxEvent.addListener(button, 'click', function (evt) {
                if (evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.isEnabled() && evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells.length > 0) {
                    if (!checkViewOrColumnForSchemaDesigner(evt.currentTarget.vm, evt.currentTarget.widgetIndex, evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0].value) && evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0].children == null && evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['vertex']) {
                        if (!evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['parent']['edge']) {
                            let columnName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0].value;
                            let viewName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0].parent.value; var getObjectFromTreeview = handleUncheckToCheckOfTreeviewWhenColumnIsDeletedFromCanvasArea(evt.currentTarget.vm, evt.currentTarget.widgetIndex, viewName, columnName, scope, compile, true);
                            handleDeleteViewAndItsColumnsNameForSchemaDesigner(evt.currentTarget.vm, evt.currentTarget.widgetIndex, getObjectFromTreeview, scope, compile);
                            editor.execute(action);
                        }
                        else
                            gtoastr.error('This point cannot delete');
                    }
                    else {
                        if (evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['edge'] && evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['source'] && evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['target']) {

                            let sourceColumnName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['source']['value'];
                            let sourceTableNameOrviewName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['source']['parent']['value'];
                            let targetColumnName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['target']['value'];
                            let targetTableNameOrviewName = evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.selectionModel.cells[0]['target']['parent']['value'];
                            handleDeleteJoinKeyValue(evt.currentTarget.vm, evt.currentTarget.widgetIndex, evt.currentTarget.scope, evt.currentTarget.compile, sourceColumnName, sourceTableNameOrviewName, targetColumnName, targetTableNameOrviewName)
                    ...
                    //evt.currentTarget.vm.dashboardAndReportComInformation.widgetList[evt.currentTarget.widgetIndex].mxGraph.removeCells();
                }
        ...
        //#region destroy key handler
        var handleDestroyedkeyhandler = function (vm) {
            for (var i = 0; i < vm.dashboardAndReportComInformation.widgetList.length; i++) {

                vm.dashboardAndReportComInformation.widgetList[i].mxKeyHandler.destroy()
            ...
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxKeyHandler.bindKey(46, function (evt) {
                ...
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.isEnabled() && vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.selectionModel.cells.length > 0) {
                    if (!checkViewOrColumnForSchemaDesigner(vm, widgetIndex, vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.selectionModel.cells[0].value) && vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.selectionModel.cells[0].children == null) {
                        ...
                        let viewName = vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.selectionModel.cells[0].parent.value; var getObjectFromTreeview = handleUncheckToCheckOfTreeviewWhenColumnIsDeletedFromCanvasArea(vm, widgetIndex, viewName, columnName, scope, compile, true);
                        handleDeleteViewAndItsColumnsNameForSchemaDesigner(vm, widgetIndex, getObjectFromTreeview, scope, compile);
                    }
        ...
        var handleUncheckToCheckOfTreeviewWhenColumnIsDeletedFromCanvasArea = function (vm, widgetIndex, viewName, ColumnName, scope, compile, applyStatus) {
            var treeviewJsonQ = jsonQ(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns)
            let getColumnFromTreeview = treeviewJsonQ.find('id', function () {
                return this == handleGetIdOfColumnInTreeviewForSchemaDesginer(viewName, ColumnName)

            });
            let currentObject;
            if (getColumnFromTreeview.jsonQ_current.length > 0) {
                getColumnFromTreeview.jsonQ_current[0].path.splice(getColumnFromTreeview.jsonQ_current[0].path.length - 1, 1)
                currentObject = getColumnFromTreeview.pathValue(getColumnFromTreeview.jsonQ_current[0].path)
                ivhTreeviewMgr.deselect(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns, currentObject);
            }
        ...
        var handleInitializationOfMxGraph = function (vm, widgetIndex, scope, compile, selectorForInitializationOfMxGraph) {
            ...
            if (!mxClient.isBrowserSupported()) {
                ...
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxEditor = new mxEditor();
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph = vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxEditor.graph;
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxModel = vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxGraph.model;
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].mxEditor.setGraphContainer(container);
        ...
        var handleInitializationForSubquery = function (vm, widgetIndex, scope, rootScope, compile, uniqueId) {
            if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[uniqueId]) {
                ...
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[uniqueId].remoteDatabaseSvrsInfo = [];
                ...
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[uniqueId].save = false;
        ...
        var handleRenderDatasetAnditsColumnsMainQuery = function (vm, widgetIndex, scope, compile, currentUnique) {
            ...
            //call function for render the dataset to the left side
            let getLengthOfTreeview = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.length;
            if (getLengthOfTreeview > 0) {
                handleInitializationOfWhereClauseWhenSelectaDataSet(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.whereClauseConfiguration.whereClauseJsonWithRuleAndGroup, scope, compile, null, vm, widgetIndex);
                //for (let idx = 0; idx < getLengthOfTreeview; idx++) {
                ...
                //}
                handleCheckCentralizeDatabaseExistOrNot(vm, widgetIndex, scope, compile);
            }
        };
        //#endregion
        ...
        var reRenderDataSetAndItsColumnWithQueryAndSubquery = function (vm, widgetIndex, scope, compile, currentUnique) {
            ...
            if (getLengthOfTreeview > 0) {
                ...
                //    handleTreeviewOfViewColumnBelowQueryBuilderSection(vm, widgetIndex, scope, compile, getItemOfDataSet, false);
                //}
                handleCheckCentralizeDatabaseExistOrNotForRemoteSubquery(vm, widgetIndex, scope, compile);
            }
        ...
        var handleApplySubquery = function (vm, widgetIndex, viewName, columnName, columnDataType, scope, compile) {
            ...
            var uniqueId = viewName.replace(/ /g, '') + columnName.replace(/ /g, '') + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID;
            if ($('.' + vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID).find(".selected-rows .tg-row#" + uniqueId).length < 1) {
                let getRowHtml = ($QueryBuilderRows[0]['code']).replace(/chngidx/g, widgetIndex).replace(/uniqueKey/g, "'" + columnName + "'");
        ...
        //#region get template id base on module type and module id

        var handleGetTemplateIdBaseOnModuleTypeNModuleId = function (compile, scope, vm, filter) {
            return $.ajax({
                type: "POST",
                url: '/BusinessIntelligence/DashboardNReport/GetTemplateByModuleTypeModuleTypeId',
                data: { userID: userIDByX1, filter: filter, ModuleType: moduleInformation.ModuleType, ModuleTypeId: moduleInformation.ModuleTypeId }
            });
        ...
        var handleGetTemplateIdBaseOnModuleType = function (compile, scope, vm, filter) {
            return $.ajax({
                type: "POST",
                url: '/BusinessIntelligence/DashboardNReport/GetTemplateByModuleType',
                data: { userID: userIDByX1, filter: filter, ModuleType: moduleInformation.ModuleType }
            });
        ...
        var handleDocumentPath = function (vm, scope, compile, compareStatus, widgetIndex) {
            // var widgetIndex = 6;
            // var compareStatus = true;
            let itemTreeview = {};
            ...
            //makeDataTreeview['value'] = '~/Areas/BusinessIntelligence/Content/SamplePPT.ppt';
            //makeDataTreeview['selected'] = false;
            ...
            //calling method fto get documents list from DB
            handleGetDocumentFromDB().success(function (result) {
                if (result.status) {
                    var getData = JSON.parse(result.data);
                    if (getData.length > 0) {
                        // console.log(getData)
                        makeDataTreeview = handleTreeNodeChildren(vm, getData, itemTreeview, compareStatus, vm.dashboardAndReportComInformation.widgetList[widgetIndex].documentsViewConfiguration.documentPath)
                        itemTreeview['selected'] = true;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].documentPathList.push(makeDataTreeview);
                    }
                    else {
                        //  console.log("Documents has not been found")
                    }
        ...
        //#region tree node children
        var handleTreeNodeChildren = function (vm, getData, itemTreeview, compareStatus, compareDocumentPath) {
            $.each(getData, function (index, item) {
                // console.log('result: ' + getData[index] + '   item: ' + item);
                makeDataTreeview = {};
                makeDataTreeview['label'] = getData[index].Description;///DocCategory;//'sample.ppt';
                makeDataTreeview['id'] = getData[index].Description; //'ppt';
                makeDataTreeview['value'] = getData[index].FileName;// '~/Areas/BusinessIntelligence/Content/SamplePPT.ppt';
                // used global variable for doc name comparing
                if (compareStatus == true) {
                    if (compareDocumentPath.localeCompare(getData[index].FileName) == 0)
                        makeDataTreeview['selected'] = true;
                    else
                        makeDataTreeview['selected'] = false;
                }
        ...
        //#region for get document from db
        var handleGetDocumentFromDB = function () {
            //pending implementation for DB
            return $.ajax({
                method: 'POST',
                url: '/BusinessIntelligence/DashboardNReport/GetDocumentsFromDB'
        ...
        var handleLockGridStack = function () {
            ...
            if (typeof lockGridStack != "undefined") {
            ...
            if ($('.tab-content .tab-pane> .grid-stack').length > 0) {
                $('.tab-content .tab-pane> .grid-stack').each(function (idx, item) {
                    ...
                    if (typeof lockGridStackChild != "undefined") {
        ...
        //#region handleDeleteChildWidgetOfTab
        var handleDeleteChildWidgetOfTab = function (vm, widgetIndex) {
            vm.dashboardAndReportComInformation.widgetList[widgetIndex].isDeleted
            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].PWidgetID == null) {
                let getChildWidgetList = vm.dashboardAndReportComInformation.widgetList.filter(x=>x.PWidgetID == vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                if (getChildWidgetList.length > 0) {
                    getChildWidgetList.filter((value) => {
        ...
        //#region If columns is selected, then should be checked for remote

        var handleColumnsSelectedRemote = function (vm, widgetIndex, scope, compile, dataSource) {
            let getDatabase = $.extend(true, {}, vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']]);
            let tablesNViews = getDatabase['children'];
            let getLength = tablesNViews.length;
            for (let i = 0; i < getLength; i++) {

                let getColumns = tablesNViews[i]['children'];
                let getColLen = getColumns.length;
                for (let inrIndx = 0; inrIndx < getColLen; inrIndx++) {
                    let tablesNviewsNColumns = getColumns[inrIndx]['children'];
                    let tablesNviewsNColumnsLen = tablesNviewsNColumns.length;
                    let getselectedViewsNTablesIndex = -1;

                    if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueryStatus) {


                        getselectedViewsNTablesIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSelectedViews.findIndex(x=>x['table'] == getColumns[inrIndx]['value'] && x['remoteDatabase'] == getColumns[inrIndx]['children'][0]['remoteDatabase']);
                    } else {
                        getselectedViewsNTablesIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].multiSelectedViews.findIndex(x=>x['table'] == getColumns[inrIndx]['value'] && x['remoteDatabase'] == getColumns[inrIndx]['children'][0]['remoteDatabase']);

                    }
                    if (getselectedViewsNTablesIndex > -1) {
                        handleDrawTableForSchemaDesigner(vm, widgetIndex, getColumns[inrIndx]['value'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
                        for (let i = 0; i < tablesNviewsNColumnsLen; i++) {
                            let columnItem = tablesNviewsNColumns[i];
                            let dataType = handleGetcolumnTypeWhenRenderInBelowDatdaset(columnItem.ColumnDataType);
                            vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName.push({ name: columnItem['value'] + "." + columnItem.ColumnName, DataType: dataType, DisplayType: columnItem.IsSelectType });
                    ...
                    let size = 0;
                    for (let inx1Indx = 0; inx1Indx < tablesNviewsNColumnsLen; inx1Indx++) {
                        let getColumnIndex = vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue.findIndex(x => x.key == tablesNviewsNColumns[inx1Indx]['value'] && x.value['label'] == tablesNviewsNColumns[inx1Indx]['label']);
                        if (getColumnIndex > -1) {
                            if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchmaDesignerOnKeyValue[getColumnIndex]['value']['selCSta']) {
                                tablesNviewsNColumns[inx1Indx]['selected'] = true;
                            }
                            size++;

                            handleRedrawColumnInTableForSchemaDesigner(vm, widgetIndex, tablesNviewsNColumns[inx1Indx]['value'], tablesNviewsNColumns[inx1Indx]['label'], vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID, size);
        ...
        //#region handleAddRemoteServersInDbWhenAddDbInWidget

        var handleAddRemoteServersInDbWhenAddDbInWidget = function (vm, widgetIndex, scope, compile, dataSource) {

            if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueryStatus) {
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.length > 0) {

                    if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.findIndex(x=>x.remoteDatabase == dataSource['remoteDatabase'] && x.dataSourceName == dataSource['dataSourceName']) < 0) {
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.push(dataSource);
                    }
                }
                else {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.remoteDatabaseSvrsInfo.push(dataSource);
                ...
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.length > 0) {
                    ...
                    if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.findIndex(x=>x.remoteDatabase == dataSource['remoteDatabase'] && x.dataSourceName == dataSource['dataSourceName']) < 0) {
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.push(dataSource);
                    }
                }
                else {
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].remoteDatabaseSvrsInfo.push(dataSource);
        ...
        //#region handleSetValueOfDataSource
        var handleSetValueOfDataSource = function (lable, value, select, id, children) {

            let putValueForTreeview = {};
            putValueForTreeview['label'] = lable;
            putValueForTreeview['selected'] = select;
            putValueForTreeview['value'] = value;
            putValueForTreeview['id'] = id;
            putValueForTreeview['children'] = children;
            return putValueForTreeview;

        };

        //#endregion

        //#region handleAddDatabaseFromClientSide
        var handleAddDatabaseFromClientSide = function (vm, widgetIndex, scope, compile, dataSource) {

            handleAddDataSourceOrDatabaseInCurrenWidget(vm, widgetIndex, scope, compile, dataSource);
        };
        //#endregion

        //#region handleAddDataSourceOrDatabaseInCurrenWidget
        var handleAddDataSourceOrDatabaseInCurrenWidget = function (vm, widgetIndex, scope, compile, dataSource) {
            let findIndexOfDataSource = vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns.findIndex(x=>x.label == dataSource['dataSourceName']);
            if (findIndexOfDataSource > -1) {
                let findIndexOfDatabase = vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns[findIndexOfDataSource].children.findIndex(x=>x.label == dataSource['remoteDatabase']);
                if (findIndexOfDatabase < 0) {
                    let getDatabase = handleColumnsSelectedRemote(vm, widgetIndex, scope, compile, dataSource);
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns[findIndexOfDataSource].children.push(getDatabase);
                    //  console.log(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasets)
                    handleAddRemoteServersInDbWhenAddDbInWidget(vm, widgetIndex, scope, compile, dataSource);
                    //console.log(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasets)
                }
            }
            else {

                let putDatasource = handleSetValueOfDataSource(dataSource['dataSourceName'], dataSource['dataSourceName'], false, dataSource['dataSourceName'], []);
                let getDatabase = handleColumnsSelectedRemote(vm, widgetIndex, scope, compile, dataSource);
                var currentobj = Object.assign({}, getDatabase);
                //   console.log(getDatabase)
                putDatasource.children.push(currentobj);
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns.push(putDatasource);
                handleAddRemoteServersInDbWhenAddDbInWidget(vm, widgetIndex, scope, compile, dataSource);
                handleAddColumnsOrRemoveColumnInWhereCluase(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].SelectedTablesColumnName);
        ...
        //#region handleAddCentralizeDataSource
        var handleAddCentralizeDataSource = function (vm, widgetIndex, scope, compile, dataSource) {
            if (!vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']]) {

                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']] = {};
                return false;
            }
            return true;
        }
        ...
        //#region handleAddCentralizeDatabase
        var handleAddCentralizeDatabase = function (vm, widgetIndex, scope, compile, dataSource, children) {


            if (!vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']]) {
                let putDatabase = handleSetValueOfDataSource(dataSource['remoteDatabase'], dataSource['remoteDatabase'], false, dataSource['remoteDatabase'], children);
                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']] = putDatabase;

                let makeDdl = {};
                makeDdl['text'] = dataSource['remoteDatabase'];
                makeDdl['value'] = dataSource['remoteDatabase'];
                makeDdl['groupBy'] = dataSource['dataSourceName'];
                makeDdl['source'] = dataSource;
                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseGroupBysource.push(makeDdl);
                return false;
        ...
        //#region handleAddCentralizeDatabase RPT
        var handleAddCentralizeDatabaseRPT = function (vm, widgetIndex, scope, compile, dataSource, children) {


            if (!vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']]) {
                let putDatabase = handleSetValueOfDataSource(dataSource['remoteDatabase'], dataSource['remoteDatabase'], false, dataSource['remoteDatabase'], children);
                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']] = putDatabase;
                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseGroupBysource = [];
                let makeDdl = {};
                makeDdl['text'] = dataSource['remoteDatabase'];
                makeDdl['value'] = dataSource['remoteDatabase'];
                makeDdl['groupBy'] = dataSource['dataSourceName'];
        ...
        //#region group by views and tables

        var handleGroupByViewsNTables = function (vm, widgetIndex, scope, compile, dataSource, viewsNTables) {
            ...
            let getTreeViews = Object.keys(getKeyValueOfViewsNTables).map((key) => {
                ...
                return { label: key, selected: false, value: key, children: handleGroupByViewsNTablesNColumns(getKeyValueOfViewsNTables[key], dataSource) };

            });
            if (!handleAddCentralizeDataSource(vm, widgetIndex, scope, compile, dataSource)) {
                if (!handleAddCentralizeDatabase(vm, widgetIndex, scope, compile, dataSource, getTreeViews)) {

                    //nothing
                }

                //vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns.push($.extend(true, {}, vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo[dataSource['dataSourceName']][dataSource['remoteDatabase']]));
        ...
        //#region group by views and tables RPT

        var handleGroupByViewsNTablesRPT = function (vm, widgetIndex, scope, compile, dataSource, viewsNTables) {
            let getKeyValueOfViewsNTables = viewsNTables.reduce((finalList, currentItem) => {
                finalList[currentItem['TableType']] = finalList[currentItem['TableType']] || [];
                finalList[currentItem['TableType']].push(currentItem);
                return finalList;
            ...
            if (!handleAddCentralizeDataSource(vm, widgetIndex, scope, compile, dataSource)) {
                if (!handleAddCentralizeDatabaseRPT(vm, widgetIndex, scope, compile, dataSource, getTreeViews)) {
        ...
        //#region group by tables and columns

        var handleGroupByViewsNTablesNColumns = function (tablesNColumns, dataSource) {
            let getKeyValueOfTablesNColumns = tablesNColumns.reduce((finalList, currentItem) => {
                ...
                let makeTreeviews = {};
                makeTreeviews['label'] = currentItem['ColumnName'];
                makeTreeviews['selected'] = false;
                makeTreeviews['value'] = currentItem['tableName'];
                makeTreeviews['IsSelectType'] = currentItem['IsSelectType'];
                makeTreeviews['id'] = handleGetIdOfColumnInTreeviewForSchemaDesginer(currentItem['tableName'], currentItem['ColumnName']);
                makeTreeviews['ColumnName'] = currentItem['ColumnName'];
                makeTreeviews['Schemas'] = currentItem['Schemas']
                makeTreeviews['ColumnDataType'] = currentItem['ColumnDataType'];
                makeTreeviews['dataType'] = currentItem['ColumnDataType'];
                makeTreeviews['dataSourceName'] = dataSource['dataSourceName'];
                makeTreeviews['remoteDatabase'] = dataSource['remoteDatabase'];
                makeTreeviews['TableType'] = currentItem['TableType'];
                finalList[currentItem['tableName']].push(makeTreeviews);
                return finalList;
            ...
            return Object.keys(getKeyValueOfTablesNColumns).map((key) => {
                return { label: key, id: key, selected: false, value: key, children: getKeyValueOfTablesNColumns[key] };
            });
        };
        //#endregion

        //#region draw widgets when you change the type for shutter up/down

        var handleDrawWidgetsTypeShutterUpDown = function (vm, scope, compile, uiGridConstants, rootScope) {
            let addMurriMainDiv = "<div class='grid-stack' data-pagename='" + vm.dashboardAndReportComInformation.templateTitle + "'></div>";
            $(".new-template").addClass("start-drawing").append(addMurriMainDiv);
            xl_script.initGridStack();
            airviewXcelerateAppSettings.getAddNewWidgetInGridStack();
            addWidgerHandler(scope, compile, vm, gtoastr);
            let getLengthOfWidgetList = vm.dashboardAndReportComInformation.widgetList.length;
            for (let index = 0; index < getLengthOfWidgetList; index++) {
                // let parentElement = $(".new-template .page");
                let settingsAndAdvanceSettingsSelector = $(".side-panel .tab-content .tab-pane > .toggle");
                ...
                if (typeof vm.dashboardAndReportComInformation.widgetList[index].loading == "undefined") {
                    vm.dashboardAndReportComInformation.widgetList[index]['loading'] = true;
                }
                vm.dashboardAndReportComInformation.widgetList[index].loading = true;
                if (typeof vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.shtrType == "undefined") {
                    vm.dashboardAndReportComInformation.widgetList[index].widgetConfiguration.shtrType = shutterType.down;
        ...
        //#region change type of shutter up/down
        var handleChangeTypeForShutterUpDown = function (vm, scope, compile, shutterUpDownStatus, uiGridConstants, rootScope) {

            handleSetValueTopLeftWidthAndRightOfWidgetShutterUpDown(vm.dashboardAndReportComInformation).done((res) => {
                currentShutterType = shutterUpDownStatus;
                console.log(res)
                handleClearSidePanelQueryBuilderNCanvasArea(compile, scope, vm);
                handleDrawWidgetsTypeShutterUpDown(vm, scope, compile, uiGridConstants, rootScope);
                xl_script.scrollbar();
            });
        ...
        //#region clear the side panel, query builder and canvas area
        var handleClearSidePanelQueryBuilderNCanvasArea = function (compile, scope, vm) {
            var getPanelsPageSettings = $(".side-panel .tab-content  .tab-pane > .toggle > div").slice(0, 3).detach();
        ...
        //#region bind entityID with all predefine widgets when add then new entity from BI

        var handleBindEntityIdWithPreWdget = function (vm, scope, compile, entityInformation) {
            vm.getDataBaseOnId = entityInformation['EntityId'];
            let getLen = vm.dashboardAndReportComInformation.widgetList.length;
            if (getLen > 0) {
                for (let i = 0; i < getLen; i++) {
                    if (vm.dashboardAndReportComInformation.widgetList[i].widgetType == 'widgetOfPredefined') {
                        $('#' + vm.dashboardAndReportComInformation.widgetList[i].widgetID).find('.content-wrapper').empty();
                        handleInitPredefinedView(vm, i, scope, compile, $('#' + vm.dashboardAndReportComInformation.widgetList[i].widgetID).find('.content-wrapper'))
                    }
        ...
        var hanldeInitialization = function (compile, scope, vm, uiGridConstants, $timeout, toastr, rootScope) {
            ...
            //#region initialization the objects and call functions for dashboard & report
            vm.dashboardAndReportComInformation = {};
            ...
            vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo = {};
            vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseGroupBysource = [];
            vm.dashboardAndReportComInformation.widgetList = [];
            vm.dashboardAndReportComInformation.documentPath = [];
            vm.dashboardAndReportComInformation.documentListFromDB = [];
            deleteChildTabWidget = []
            vm.modeType = '';
            ...
            if (moduleInformation.ModuleTypeId != null && moduleInformation.ModuleTypeId > 0) {
                ...
                if (moduleInformation.ModuleType != null) {
                    ...
                    handleGetTemplateIdBaseOnModuleTypeNModuleId(compile, scope, vm, 'GetTmpIdMdleTypeNMdleTypeId').success(function (res) {

                        if (res.status) {
                            var getTemplate = $.parseJSON(res.data);
                            handleGetDefaultTemplateByUserID(getTemplate[0].TemplateId).then(function successCallback(response) {
                                ...
                                setTimeout(function () { scope.$emit('InOtherModuleTempNotaddE', { addTempStatus: false }); }, 800)
                                if (moduleInformation.RenderId && vm.coreModeTypeInte == "VIEW") {
                                    handleChangeModeType(compile, scope, vm, 'view');
                                    setTimeout(function () {
                                        scope.$emit('changeModeTypeInTopHeaderE', 'view');
                                        handleLockGridStack();
                                    }, 800);
                                    ...
                                    setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', 'edit'); }, 800);
                                }
                            ...
                            handleGetTemplateIdBaseOnModuleType(compile, scope, vm, 'GetTmpIdMdleType').success(function (res) {
                                if (res.status) {
                                    var getTemplate = $.parseJSON(res.data);
                                    setTimeout(function () { scope.$emit('InOtherModuleTempNotaddE', { addTempStatus: false }); }, 1000)
                                    var getTemplate = $.parseJSON(res.data);
                                    handleGetDefaultTemplateByUserID(getTemplate[0].TemplateId).then(function successCallback(response) {
                                        handleReplaceUniIdForIntregratedModule(compile, scope, vm, uiGridConstants, response.data.data, rootScope).done((res) => {
                                            handleIntegratedModuleJsonForFrontend(compile, scope, vm, uiGridConstants, res, rootScope)
                                            handleChangeModeType(compile, scope, vm, "edit");
                                            isModeForTab = true;
                                            setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', 'edit'); }, 1000);
                                            addWidgerHandler(scope, compile, vm, toastrs);
                                            handleUnlockGridStack();
                                            xl_script.scrollbar();
                                        });
                                    ...
                                    setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', 'nothings') }, 800);
                                }
                            });
                ...
                handleGetTemplateIdBaseOnModuleType(compile, scope, vm, 'GetTmpIdMdleType').success(function (res) {
                    if (res.status) {
                        ...
                        handleGetDefaultTemplateByUserID(getTemplate[0].TemplateId).then(function successCallback(response) {
                            ...
                            handleChangeModeType(compile, scope, vm, "edit");
                            isModeForTab = true;
                            scope.$emit('changeModeTypeInTopHeaderE', "edit");
                            setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', "edit"); }, 800)
                ...
                handleGetDefaultTemplateIDByUserID("GetPriTmpOnlyActiveByUserID").then(function successCallback(res) {
                    if (res.data.status) {
                        ...
                        handleGetDefaultTemplateByUserID(getTemplate[0].TemplateId).then(function successCallback(response) {
                            handleChangeModeType(compile, scope, vm, "view");
                            isModeForTab = false;
                            setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', "view") }, 500);
                            handleJsonForFrontend(compile, scope, vm, uiGridConstants, response.data.data, rootScope);
                        ...
                        toastr.success('Data has not been found');
                        setTimeout(function () { scope.$emit('changeModeTypeInTopHeaderE', 'nothings') }, 500);
                    }
                    // this callback will be called asynchronously
                    // when the response is available
                }, function errorCallback(response) {
            ...
            //#region add new dashboard and report
            scope.$on("dashboardAndReportB", function (event, dashboardInfo) {
                ...
                xl_script.scrollbar();
                //   getViewsOfDb(vm);
                //make a ajax call for a doument which are the centralize of all document widget
                // handleDocumentPath(vm, scope, compile, true, currentIndex);
                handleUnlockGridStack();
            ...
            //#region load dashboard when select dashbaord from ddl
            ...
            //#region set params for EMS Or Other module integration            
            vm.getDataBaseOnId = moduleInformation.RenderId;
            vm.standardWidgets = airviewXcelerateAppSettings.getStandardPanel();
            vm.dynamicPridefinedWidget = airviewXcelerateAppSettings.getDynamicPredefinedWidget(moduleInformation.ModuleType);
            vm.layoutTypeDefaultPage = airviewXcelerateAppSettings.getLayoutForDefaultWidget();

            scope.$on('bindEntityTemplateIdOnAllWidgetB', (event, entityInformation) => {

                handleBindEntityIdWithPreWdget(vm, scope, compile, entityInformation);

            });
            //#endregion

            //#region Image upload for default page
            ...
            //#region set toaster, treeview and uigrid
            ...
            //#region add remote datasource
            vm.addRemoteDataSource = function (widgetIndex) {
                // console.log(widgetIndex);
                vm.openLinkProperteisModal = $uibModal.open({
                    templateUrl: 'dsrpt/DashboardNReport/getPartialPage/QueryBuilder/_AddRemoteDataSource.cshtml',
                    backdrop: 'static',
                    controller: "RemoteDataSource as vm",
                    resolve: {
                        pvm: function () {
                            return vm;
                        },
            ...
            vm.applyFilter = function (widgetIndex) {
                handleGetDataToGivenValueForAllWidgets(vm, widgetIndex, scope, compile, true);
            };
            ...
            scope.$on("changeModeTypeB", function (event, modeType) {
                //if (modeType == "view")
                //    gridInfo.verticalMargin(7);
                //else {
                //    gridInfo.verticalMargin(8)
                //}
            ...
            scope.$on('postViewsNTablesNColumnsB', (event, dataSourceNViewsNTablesNColumns) => {

                handleGroupByViewsNTables(vm, dataSourceNViewsNTablesNColumns['widgetIndex'], scope, compile, dataSourceNViewsNTablesNColumns['dataSource'], dataSourceNViewsNTablesNColumns['viewsTablesNColumn']);
            });
            scope.$on('postViewsNTablesNColumnsRPTB', (event, dataSourceNViewsNTablesNColumns) => {
                console.log(dataSourceNViewsNTablesNColumns)
                vm.dashboardAndReportComInformation.centralizeDataSourceNDatabaseInfo = {};
                scope.$apply();
                handleGroupByViewsNTablesRPT(vm, dataSourceNViewsNTablesNColumns['widgetIndex'], scope, compile, dataSourceNViewsNTablesNColumns['dataSource'], dataSourceNViewsNTablesNColumns['viewsTablesNColumn']);
            });
            scope.$on('changeShutterUpDownStatusB', (event, shutterUpDownStatus) => {
                handleChangeTypeForShutterUpDown(vm, scope, compile, shutterUpDownStatus, uiGridConstants, rootScope);
            ...
            vm.addDatasourceFromClientSide = function (widgetIndex) {
                //  console.log('datasource' + vm.dataSources);
                handleAddDatabaseFromClientSide(vm, widgetIndex, scope, compile, vm.dataSources['source']);
            ...
            //#region charts object initliazation
            vm.chart = {};
            vm.chart.settings = {};
            ...
            //#region define charts companies and types
          ...
          { id: 2, keycode: "canvasCharts", companyName: `Canvas charts` }];
            ...
            //#region set value format for charts


            vm.chart.valueFormattingString = [
                { value: '', text: 'None' },
            ...
            vm.chart.settings.XaxisSettings.valueFormattingDropdown = function (widgetIndex) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingInput = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.XaxisSettings.valueFormattingDropdown;
                handleSetChartTypeOfCanvas(compile, scope, vm, widgetIndex);
                handleCheckChartType(compile, scope, vm, widgetIndex);

            };
            vm.chart.settings.XaxisSettings.valueFormattingInput = function (widgetIndex) {
                handleSetChartTypeOfCanvas(compile, scope, vm, widgetIndex);
                handleCheckChartType(compile, scope, vm, widgetIndex);
            };
            ...
            vm.chart.settings.YaxisSettings.valueFormattingDropdown = function (widgetIndex) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingInput = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.settings.YaxisSettings.valueFormattingDropdown;
                handleSetChartTypeOfCanvas(compile, scope, vm, widgetIndex);
                handleCheckChartType(compile, scope, vm, widgetIndex);
            };
            vm.chart.settings.YaxisSettings.valueFormattingInput = function (widgetIndex) {
                handleSetChartTypeOfCanvas(compile, scope, vm, widgetIndex);
                handleCheckChartType(compile, scope, vm, widgetIndex);
            };
            ...
            //#region add drilldown charts

            vm.chart.addDrilldownChart = function (widgetIndex) {
                let panelType = "widgetOfChart";
                let getPanelCodeBaseOnWidgetTypeElement = getWidgetSettings.find(x => x.type == panelType);
                let getQueryBuilderElement = getWidgetSettings.find(x => x.type == "queryBuilder").code;
                handleDragWidget(getPanelCodeBaseOnWidgetTypeElement.code, addWidgetOfGridStackItem, $(".side-panel .tab-content .tab-pane > .toggle"), getPanelCodeBaseOnWidgetTypeElement.settings, getPanelCodeBaseOnWidgetTypeElement.advanced_settings, getQueryBuilderElement, $(".side-panel #queryBuilderSection"), compile, scope, vm, panelType, toastrs, null, { isRender: false, prevUniqueKey: vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex].widgetID, nextUniqueKey: null, rendorUniqueKey: vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID, isDrilldownStatus: true, previousWidgetIndex: vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex, renderWidgetIndex: widgetIndex, title: 'chart' });
                // scope.$apply();
            }

            vm.chart.deleteDrilldownChart = function (widgetIndex, renderIdx) {
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey == null) {
                    let getPrevWidgetIndex = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey);
                    if (getPrevWidgetIndex > -1) {
                        vm.dashboardAndReportComInformation.widgetList[getPrevWidgetIndex].chartConfigurations.drilldownParams.nextUniqueKey = null;
                        vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex = getPrevWidgetIndex;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey = null;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].isDeleted = true;
                        handleSetClickEventForCharts(compile, scope, vm, getPrevWidgetIndex);
                        $.when($(".querybuilder-wrapper , .widget-settings,.default_advance_settings ").fadeOut()).done(function () {
                            $('.' + vm.dashboardAndReportComInformation.widgetList[getPrevWidgetIndex].widgetID).fadeIn();
                        });
                        handleChartRenderOfCanvasDrilldown(null, null, vm, renderIdx, getPrevWidgetIndex);

                        handleFillTreeviewForChartsDrilldown(vm, renderIdx, getPrevWidgetIndex, gscope, gcompile);
                        currentIndex = getPrevWidgetIndex;
                    }
                }
                else if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey != null) {
                    let getPrevWidgetIndex = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey);
                    let getnextvWidgetIndex = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey);
                    if (getPrevWidgetIndex > -1 && getnextvWidgetIndex > -1) {
                        vm.dashboardAndReportComInformation.widgetList[getPrevWidgetIndex].chartConfigurations.drilldownParams.nextUniqueKey = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey;
                        vm.dashboardAndReportComInformation.widgetList[getnextvWidgetIndex].chartConfigurations.drilldownParams.prevUniqueKey = vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey;
                        vm.dashboardAndReportComInformation.widgetList[renderIdx].activeWidgetIndex = getPrevWidgetIndex;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.prevUniqueKey = null;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].chartConfigurations.drilldownParams.nextUniqueKey = null;
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].isDeleted = true;
                        handleSetClickEventForCharts(compile, scope, vm, getPrevWidgetIndex);
                        $.when($(".querybuilder-wrapper , .widget-settings,.default_advance_settings ").fadeOut()).done(function () {
                            $('.' + vm.dashboardAndReportComInformation.widgetList[getPrevWidgetIndex].widgetID).fadeIn();
            ...
            vm.chart.backActionOnDrilldown = function (widgetIndex) {
                if (vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex].chartConfigurations.drilldownParams.prevUniqueKey != null) {
                    var getPreIdx = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex].chartConfigurations.drilldownParams.prevUniqueKey);
                    handleChartRenderOfCanvasDrilldown(null, null, vm, widgetIndex, getPreIdx);
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex = getPreIdx;
                    handleFillTreeviewForChartsDrilldown(vm, widgetIndex, getPreIdx, scope, compile);
                    //  $('#'+nextUniqueKey).addClass("change-settings").siblings().removeClass("change-settings");
                    $.when($(".querybuilder-wrapper , .widget-settings,.default_advance_settings ").fadeOut()).done(function () {
                        $("." + vm.dashboardAndReportComInformation.widgetList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].activeWidgetIndex].widgetID).fadeIn();
                    });
            ...
            vm.loadDataOnWidgetClick = function (widgetIndex) {
                ...
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.multiSchemaEnableOrDisable) {
                    if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].loading) {
                        handleCheckCentralizeDatabaseExistOrNot(vm, widgetIndex, scope, compile);
                        vm.dashboardAndReportComInformation.widgetList[widgetIndex].loading = false;
                        $timeout(function () {
                            handleRenderEdgesWhenTemplateIsReloadingFromDB(vm, widgetIndex, scope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetID);
            ...
            vm.reloadingOfMurri = function () {
                if (typeof vm.dashboardAndReportComInformation.widgetList[currentIndex] != "undefined") {
                    $timeout(function () { vm.dashboardAndReportComInformation.widgetList[currentIndex].murriInitializationOfSelectedColumn._resizeHandler(); }, 350);
                }
            ...
            vm.DeleteQBSelectedRows = function (widgetIndex) {
                ...
                if (thisRow.length > 0)
                    toastrs.success("Deleted successfully");
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].murriInitializationOfSelectedColumn.remove(arr, { removeElements: true });
            ...
            vm.removeWidget = function (event, widgetIndex) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].isDeleted = true;
                handleDeleteChildWidgetOfTab(vm, widgetIndex);
                let parent = $(event.target).closest('.grid-stack-item');
                var grid = $('.grid-stack').data('gridstack');
                $(event.target).closest('.widget').slideUp("complete", function () {
            ...
            vm.ClickMarketLevelMap = function (WigetIndex) {
                if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.MarketLevel == true) {
                    if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere == '()') {
                        ...
                        GetQuery = "Select (COUNT(*)) as TotalMarketRecords, Market As RecordValue, Country, (select count(*) from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + " Where " + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere + ") a ) as TotalRecords from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + " Where " + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere + ") b GROUP by Market, Region, State, Country";
                    }
                ...
                if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.mapleveltype == 'Market') {
                    ...
                    if (!isPinColorApplyBtnClicked) {
                        ...
                        if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere == '()') {
                            ...
                            GetQuery = "Select (COUNT(*)) as TotalMarketRecords, Market As RecordValue, Country, (select count(*) from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ") b) as TotalRecords from (" + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ") a GROUP by Market, Region, State, Country";
                        }
                        ...
                        LoadFinalDataForMap(compile, scope, vm, WigetIndex, vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild, true);
                        // initMapDynamic(compile, scope, vm, WigetIndex);
                    }
                    // code end
                }
            ...
            vm.Savemarketfilterchkbox = function (WigetIndex, event) {
                ...
                if (countcity >= 0 && countcity < 1000) {
                    ...
                    let GetQuery = '';
                    if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryWhere == '()') {
                        GetQuery = selectStr + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryColumns + ' from (' + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ') a Where 1 = 1 ' + str;
                        ...
                        GetQuery = selectStr + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryColumns + ' from (' + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.sqlQueryBuild + ") a" + str;
                        if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryGroupBy != "") {
                            GetQuery += ' Group By ' + vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQueryGroupBy;
                        }
                        if (vm.dashboardAndReportComInformation.widgetList[WigetIndex].widgetConfiguration.whereClauseConfiguration.mapsqlQuerySortBy != "") {
            ...
            //jQuery.get('Areas/BusinessIntelligence/assets/js/fontawesome-5.json', function (data) {
            //    let tempArr = [];
            //    $.each(Object.keys(data), function (i, e) {
            //        tempArr.push({ key: e, value: data[e] });
            //    });
            ...
            //});
            //console.log(vm.tabFontawesomeIcon);
            ...
            vm.changeDocumentType = function (ivhNode, ivhIsSelected, ivhTree, widgetIndex) {
                unSelectedAllOtherChild(ivhNode, ivhIsSelected, ivhTree, widgetIndex)
                if (ivhIsSelected) {
                    //console.log(ivhNode.value);
                    vm.dashboardAndReportComInformation.widgetList[widgetIndex].documentsViewConfiguration.documentPath = ivhNode.value;
            ...
            //#endregion
            //# region to un select all check box ec=xcept current box
            //added by sohail
            var unSelectedAllOtherChild = function (ivhNode, ivhIsSelected, ivhTree, widgetIndex) {
                for (var i = 0; i < ivhTree[0].children.length; i++) {
                    // console.log(i)
                    if (ivhTree[0].children[i].value != ivhNode.value) {
                        ivhTree[0].children[i].selected = false
                    }
                }
            ...
            vm.displayDataRowsColumnsForm = function (widgetIndex) {
                ...
                handleGetStatusColors(vm, widgetIndex, scope, compile);
                switch (vm.dashboardAndReportComInformation.widgetList[widgetIndex].defaultPageConfiguration.layoutTypeDefaultPage) {
                    case "Layout 1":
                        handleDrawDataRowsColumnsFormWithDefaultPage(vm, widgetIndex, scope, compile);

                        break;
                    case "Layout 2":
                        handleDrawDataRowsColumnsFormWithDefaultPageSecondLayout(vm, widgetIndex, scope, compile);
                        break;
            ...
            vm.applySubQuery = function (widgetIndex) {
                //comment for temp  handleInitializationForSubquery(vm, widgetIndex, scope, rootScope, compile, vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId);
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].save = true;
                let columsNameList = [];
                ...
                querycolumns = querycolumns.substring(0, querycolumns.length - 1);
                let finalquery = '';
                finalquery = 'Select' + querycolumns + ' from ' + handleSelectTablesNameWhenDoNotSelectAtleastOneJoin(vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].multiSelectedViews);
            ...
            vm.backSubQuery = function (widgetIndex) {
                if (!vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId].save) {
                    delete vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.currentSubqueryUniqueId];
                }
            ...
            vm.deleteSubquery = function (event, widgetIndex, uniqueKeyOfSubquery) {
                delete vm.dashboardAndReportComInformation.widgetList[widgetIndex].widgetConfiguration.multiSchemaDesignerModels.subQueriesList[uniqueKeyOfSubquery];
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].murriInitializationOfSelectedColumn.remove([$(event.target).closest('.tg-row')[0]], { removeElements: true });
            }

            $('.new-template').on('click', '.mytab > ul > li > a', function (e) {
                $($(this).attr('data-target')).siblings().removeClass('active show');

            });
            vm.resizeAllWidgetInCurrentTab = (parentWidgetId, tabIndex) => {
                let getParentIndex = vm.dashboardAndReportComInformation.widgetList.findIndex(x=>x.widgetID == parentWidgetId);
                let childWidgetList = vm.dashboardAndReportComInformation.widgetList[getParentIndex].widgetConfiguration.TabsInfo[tabIndex].WidgetList;
                $.each(childWidgetList, (index, value) => {
                    var childWidgetIndexOf = vm.dashboardAndReportComInformation.widgetList.findIndex(x => x.widgetID == value && x.isDeleted != true);
                    // console.log(childWidgetIndexOf)
                    if (childWidgetIndexOf > -1) {
                        handlereSizeAllWidget(compile, scope, vm, childWidgetIndexOf, uiGridConstants, $timeout);
                    }


                })
            }
            vm.datasetExpandCollapse = function (widgetIndex) {
                if (vm.dashboardAndReportComInformation.widgetList[widgetIndex].datasetExCoSta) {
                    ivhTreeviewMgr.expandRecursive(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns, vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns);
                }
                else {
                    ivhTreeviewMgr.collapseRecursive(vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns, vm.dashboardAndReportComInformation.widgetList[widgetIndex].treeviewOfMultiDatasetsWithItsColumns);
                }

            };

            vm.changeFormOrBuilder = function (widgetIndex) {
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].builderNFormStatus = !vm.dashboardAndReportComInformation.widgetList[widgetIndex].builderNFormStatus;
                vm.dashboardAndReportComInformation.widgetList[widgetIndex].builderNFormStatus == true ? vm.dashboardAndReportComInformation.widgetList[widgetIndex].builderNFormIcon = "fa fa-keyboard-o" : vm.dashboardAndReportComInformation.widgetList[widgetIndex].builderNFormIcon = "fa fa-building";
        ...
        var handleDrawChildWidgetsIfExist = function (compiledcode, vm, Index, $compile, $scope, uiGridConstants, rootScope) {
            ...
            if (TabsInfo.length > 0) {
                $.each(TabsInfo, function (i, obj) { //show active
                    ...
                    //console.log(FAicon);
                    $scope['d' + obj.tabWidgetId] = obj.Icon;
                    $scope['i' + obj.tabWidgetId] = obj.Title;
                    if (i == 0) {
                        newTab = `<li><ui-select style="width: 300px !important;display:none;" class="icon-input tabIconVal" ng-model="d` + obj.tabWidgetId + `" theme="select2" title="Choose a icon"><ui-select-match class="add-me" placeholder="">{{$select.selected.key}}</ui-select-match> <ui-select-choices repeat="icon.key as icon in iconsclass | propsFilter: {key: $select.search}"><i class="{{icon.key}}"></i></ui-select-choices></ui-select> <input style="display:none" class="newtab_input" type="text" placeholder="Tab Name" ng-model="i` + obj.tabWidgetId + `" /> <a  ng-click="vm.resizeAllWidgetInCurrentTab('` + $(compiledcode).attr('id') + `',` + i + `)"  style="display:block" class="nav-link active" data-toggle="tab" data-target="#` + obj.tabWidgetId + `"> <i class="{{d` + obj.tabWidgetId + `}}"></i><span>{{ i` + obj.tabWidgetId + `}}</span></a> <span style="display:none"  class="done-tab custom-btn icon-only"><i class="fa fa-check"></i></span> <span style="display:none"  class="delete-tab custom-btn icon-only"><i class="fa fa-trash"></i></span> </li>`;



                    } else {
                        newTab = `<li><ui-select style="width: 300px !important;display:none;" class="icon-input tabIconVal" ng-model="d` + obj.tabWidgetId + `" theme="select2" title="Choose a icon"><ui-select-match class="add-me" placeholder="">{{$select.selected.key}}</ui-select-match> <ui-select-choices repeat="icon.key as icon in iconsclass | propsFilter: {key: $select.search}"><i class="{{icon.key}}"></i></ui-select-choices></ui-select><input style="display:none" class="newtab_input" type="text" placeholder="Tab Name" ng-model="i` + obj.tabWidgetId + `" /> <a  ng-click="vm.resizeAllWidgetInCurrentTab('` + $(compiledcode).attr('id') + `',` + i + `)"  style="display:block" class="nav-link" data-toggle="tab" data-target="#` + obj.tabWidgetId + `"> <i class="{{d` + obj.tabWidgetId + `}}"></i><span>{{ i` + obj.tabWidgetId + `}}</span></a> <span style="display:none"  class="done-tab custom-btn icon-only"><i class="fa fa-check"></i></span> <span style="display:none"  class="delete-tab custom-btn icon-only"><i class="fa fa-trash"></i></span> </li>`;


                    }

                    var ngCompile = $.parseHTML(newTab);
                    $(ngCompile).find('.tabIconVal').val(obj.Icon)
                    ngCompile = $compile(ngCompile)($scope);
                    $(TabElement).append(ngCompile);
                    if (i == 0) {
                        tabContent = `<div class="tab-pane fade show active tab-canvas" id="` + obj.tabWidgetId + `"> <div class="center-icon"><i class="fa fa-ioxhost"></i></div>  <div class="grid-stack"> </div> </i></div>`;
                    } else {
                        tabContent = `<div class="tab-pane fade tab-canvas" id="` + obj.tabWidgetId + `"> <div class="center-icon"><i class="fab fa-ioxhost"></i></div>  <div class="grid-stack"> </div> </i></div>`;
                    }
                    $(compiledcode).find('.tab-content').append(tabContent);
                    // let height = $("#" + obj.tabWidgetId).parents('.content-wrapper').height();
                    $("#" + obj.tabWidgetId).find('.grid-stack').attr('data-gs-current-height', obj.height_attr);
                    $("#" + obj.tabWidgetId).find('.grid-stack').attr('style', obj.style);
                    $("#" + obj.tabWidgetId).find(".grid-stack").gridstack({
                        float: false,
                        cellHeight: 4,
                        animate: true,
                        width: 12,
                    ...
                    $.each(obj.WidgetList, function (indexInner, wID) {
                        ...
                        if (!childWidgetInfo.isDeleted) {
                            $("#" + obj.tabWidgetId).children(".center-icon").remove();
                            handleRenderWidget(element, $("#" + obj.tabWidgetId).find(".grid-stack").data('gridstack'), settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, queryBuilerEle, $(".side-panel #queryBuilderSection"), $compile, $scope, vm, childWidgetIndexOf, childWidgetInfo.widgetType, uiGridConstants, rootScope, true, childWidgetInfo.PWidgetID);
                        }
                    });
                });
            }
        ...
        var handleLog = function (msg, status) {
            if (status)
                console.log(msg)
        };
        ...
        return {
            ...
            dragWidget: function (element, parentElement, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, compile, scope, vm, widgetType, toastrs) {
                handleDragWidget(element, parentElement, settingsAndAdvanceSettingsSelector, settingsElement, advanceSettingsElement, compile, scope, vm, widgetType, toastrs, null, { isRender: true, prevUniqueKey: null, nextUniqueKey: null, rendorUniqueKey: null, isDrilldownStatus: null, title: null });
            },
