    ...
    Plugin.prototype =
            {
                ...
                initTemplate: function () {
                    ...
                    this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                            ...
                            '<div class="dtp-close"><a href="javascript:void(0);"><i class="fa fa-remove"></i></a></div>' +
                            '</header>' +
                            ...
                            '<button class="dtp-btn-now custom-btn medium color1">' + this.params.nowText + '</button>' +
                            '<button class="dtp-btn-clear  custom-btn medium color3 hidden">' + this.params.clearText + '</button>' +
                            '<button class="dtp-btn-cancel  custom-btn medium color11">' + this.params.cancelText + '</button>' +
                            '<button class="dtp-btn-ok  custom-btn medium color1">' + this.params.okText + '</button>' +
                            '<div class="clearfix"></div>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
