 ...
 */
! function(e, t) {
    "function" == typeof define && define.amd ? define(["jquery", "dot/doT", "jquery-extendext"], t) : "object" == typeof module && module.exports ? module.exports = t(require("jquery"), require("dot/doT"), require("jquery-extendext")) : t(e.jQuery, e.doT)
}(this, function($, r) {
    "use strict";
    var c = function(e, t) {
        (e[0].queryBuilder = this).$el = e, this.settings = $.extendext(!0, "replace", {}, c.DEFAULTS, t), this.model = new i, this.status = {
            id: null,
            generated_id: !1,
            group_id: 0,
            rule_id: 0,
    ...
    $.extend(c.prototype, {
        trigger: function(e) {
            var t = new $.Event(this._tojQueryEvent(e), {
                builder: this
            });
        ...
        var t = [];
        if (e && 0 !== e.length || h.error("Config", "Missing filters list"), e.forEach(function(i, e) {
                switch (i.id || h.error("Config", "Missing filter {0} id", e), -1 != t.indexOf(i.id) && h.error("Config", 'Filter "{0}" already defined', i.id), t.push(i.id), i.type ? c.types[i.type] || h.error("Config", 'Invalid type "{0}"', i.type) : i.type = "string", i.input ? "function" != typeof i.input && -1 == c.inputs.indexOf(i.input) && h.error("Config", 'Invalid input "{0}"', i.input) : i.input = "number" === c.types[i.type] ? "number" : "text", i.operators && i.operators.forEach(function(e) {
                    "string" != typeof e && h.error("Config", "Filter operators must be global operators types (string)")
                }), i.field || (i.field = i.id), i.label || (i.label = i.field), i.optgroup ? (this.status.has_optgroup = !0, this.settings.optgroups[i.optgroup] || (this.settings.optgroups[i.optgroup] = i.optgroup)) : i.optgroup = null, i.input) {
                    case "radio":
                    case "checkbox":
                        (!i.values || i.values.length < 1) && h.error("Config", 'Missing filter "{0}" values', i.id);
                        break;
                    case "select":
                        var o = [];
                        i.has_optgroup = !1, h.iterateOptions(i.values, function(e, t, r) {
                            o.push({
                                value: e,
                                label: t,
                                optgroup: r || null
                            }), r && (i.has_optgroup = !0, this.settings.optgroups[r] || (this.settings.optgroups[r] = r))
                        }.bind(this)), i.has_optgroup ? i.values = h.groupSort(o, "optgroup") : i.values = o, i.placeholder && (void 0 === i.placeholder_value && (i.placeholder_value = -1), i.values.forEach(function(e) {
                            e.value == i.placeholder_value && h.error("Config", 'Placeholder of filter "{0}" overlaps with one of its values', i.id)
                        }))
                }
            }, this), this.settings.sort_filters)
            if ("function" == typeof this.settings.sort_filters) e.sort(this.settings.sort_filters);
            else {
                var r = this;
                e.sort(function(e, t) {
        ...
        this.$el.on("change.queryBuilder", t.group_condition, function() {
            if ($(this).is(":checked")) {
                ...
                n.getModel(e).condition = $(this).val()
            }
        }), this.$el.on("change.queryBuilder", t.rule_filter, function() {
            var e = $(this).closest(t.rule_container);
            n.getModel(e).filter = n.getFilterById($(this).val())
        }), this.$el.on("change.queryBuilder", t.rule_operator, function() {
            var e = $(this).closest(t.rule_container);
            n.getModel(e).operator = n.getOperatorByType($(this).val())
        }), this.$el.on("click.queryBuilder", t.add_rule, function() {
            var e = $(this).closest(t.group_container);
            n.addRule(n.getModel(e))
        }), this.$el.on("click.queryBuilder", t.delete_rule, function() {
            var e = $(this).closest(t.rule_container);
            n.deleteRule(n.getModel(e))
        }), 0 !== this.settings.allow_groups && (this.$el.on("click.queryBuilder", t.add_group, function() {
            var e = $(this).closest(t.group_container);
            n.addGroup(n.getModel(e))
        }), this.$el.on("click.queryBuilder", t.delete_group, function() {
            var e = $(this).closest(t.group_container);
            n.deleteGroup(n.getModel(e))
        })), this.model.on({
            drop: function(e, t) {
                t.$el.remove(), n.refreshGroupsConditions()
            },
            add: function(e, t, r, i) {
                0 === i ? r.$el.prependTo(t.$el.find(">" + c.selectors.rules_list)) : r.$el.insertAfter(t.rules[i - 1].$el), n.refreshGroupsConditions()
            },
            move: function(e, t, r, i) {
                t.$el.detach(), 0 === i ? t.$el.prependTo(r.$el.find(">" + c.selectors.rules_list)) : t.$el.insertAfter(r.rules[i - 1].$el), n.refreshGroupsConditions()
            },
            update: function(e, t, r, i, o) {
                if (t instanceof l) switch (r) {
                    ...
                    case "flags":
                        ...
                        break;
                    case "filter":
                        n.updateRuleFilter(t, o);
                        break;
                    case "operator":
                        n.updateRuleOperator(t, o);
                        break;
                    case "value":
                        n.updateRuleValue(t, o)
                } else switch (r) {
                    case "error":
                        n.updateError(t);
                        break;
                    case "flags":
                        ...
                        break;
                    case "condition":
                        n.updateGroupCondition(t, o)
                }
            }
        })
    }, c.prototype.setRoot = function(e, t, r) {
        e = void 0 === e || !0 === e;
        var i = this.nextGroupId(),
            o = $(this.getGroupTemplate(i, 1));
    ...
    }, c.prototype.addGroup = function(e, t, r, i) {
        t = void 0 === t || !0 === t;
        var o = e.level + 1;
        if (this.trigger("beforeAddGroup", e, t, o).isDefaultPrevented()) return null;
        var n = this.nextGroupId(),
            l = $(this.getGroupTemplate(n, o)),
            s = e.addGroup(l);
        return s.data = r, s.flags = $.extend({}, this.settings.default_group_flags, i), s.condition = this.settings.default_condition, this.trigger("afterAddGroup", s), this.trigger("rulesChanged"), t && this.addRule(s), s
        ...
        var i = this.nextRuleId(),
            o = $(this.getRuleTemplate(i)),
            n = e.addRule(o);
        return n.data = t, n.flags = $.extend({}, this.settings.default_rule_flags, r), this.trigger("afterAddRule", n), this.trigger("rulesChanged"), this.createRuleFilters(n), !this.settings.default_filter && this.settings.display_empty_filter || (n.filter = this.change("getDefaultFilter", this.getFilterById(this.settings.default_filter || this.filters[0].id), n)), n
        ...
        var t = this.change("getRuleFilters", this.filters, e),
            r = $(this.getRuleFilterSelect(e, t));
        ...
        if (e.filter) {
            var r = this.getOperators(e.filter),
                i = $(this.getRuleOperatorSelect(e, r));
            t.html(i), e.filter.default_operator ? e.__.operator = this.getOperatorByType(e.filter.default_operator) : e.__.operator = r[0], e.$el.find(c.selectors.rule_operator).val(e.operator.type), this.trigger("afterCreateRuleOperators", e, r), this.applyRuleFlags(e)
        }
        ...
        if (e.__.value = void 0, e.filter && e.operator && 0 !== e.operator.nb_inputs) {
            for (var r = this, i = $(), o = e.filter, n = 0; n < e.operator.nb_inputs; n++) {
                var l = $(this.getRuleInput(e, n));
                0 < n && t.append(this.settings.inputs_separator), t.append(l), i = i.add(l)
            }
            t.css("display", ""), i.on("change " + (o.input_event || ""), function() {
                e._updating_input || (e._updating_value = !0, e.value = r.getRuleInputValue(e), e._updating_value = !1)
            }), o.plugin && i[o.plugin](o.plugin_config || {}), this.trigger("afterCreateRuleInput", e), void 0 !== o.default_value ? e.value = o.default_value : (e._updating_value = !0, e.value = r.getRuleInputValue(e), e._updating_value = !1), this.applyRuleFlags(e)
        }
        ...
        if (this.settings.display_errors)
            if (null === e.error) e.$el.removeClass("has-error");
            else {
        ...
        return e ? e instanceof o ? e : $(e).data("queryBuilderModel") : this.model.root
    }, c.prototype.validate = function(n) {
        n = $.extend({
            skip_empty: !1
        }, n), this.clearErrors();
        var l = this,
            e = function r(e) {
                ...
                return e.each(function(e) {
                    if (e.filter || !n.skip_empty) {
                        if (!e.filter) return l.triggerValidationError(e, "no_filter", null), void o++;
                        if (!e.operator) return l.triggerValidationError(e, "no_operator", null), void o++;
                        if (0 !== e.operator.nb_inputs) {
                            var t = l.validateValue(e, e.value);
                            if (!0 !== t) return l.triggerValidationError(e, t, e.value), void o++
                        }
                        i++
                    }
                }, function(e) {
                    var t = r(e);
                    !0 === t ? i++ : !1 === t && o++
                }), !(0 < o) && (0 === i && !e.isRoot() && n.skip_empty ? null : !!(0 !== i || l.settings.allow_empty && e.isRoot()) || (l.triggerValidationError(e, "empty_group", null), !1))
            }(this.model.root);
        ...
        var e = this.validate(n);
        if (!e && !n.allow_invalid) return null;
        var l = this,
            t = function r(e) {
                var o = {
                ...
                if (e.data && (o.data = $.extendext(!0, "replace", {}, e.data)), n.get_flags) {
                    var t = l.getGroupFlags(e.flags, "all" === n.get_flags);
                    $.isEmptyObject(t) || (o.flags = t)
                }
                return e.each(function(e) {
                    if (e.filter || !n.skip_empty) {
                        var t = null;
                        ...
                        if ((e.filter && e.filter.data || e.data) && (r.data = $.extendext(!0, "replace", {}, e.filter.data, e.data)), n.get_flags) {
                            var i = l.getRuleFlags(e.flags, "all" === n.get_flags);
                            $.isEmptyObject(i) || (r.flags = i)
                        }
                        o.rules.push(l.change("ruleToJson", r, e))
                    }
                }, function(e) {
                    var t = r(e);
                    0 === t.rules.length && n.skip_empty || o.rules.push(t)
                }, this), l.change("groupToJson", o, e)
            }(this.model.root);
        return t.valid = e, this.change("getRules", t)
    }, c.prototype.setRules = function(e, o) {
        o = $.extend({
            allow_invalid: !1
        }, o), $.isArray(e) && (e = {
            condition: this.settings.default_condition,
            rules: e
        }), e && e.rules && (0 !== e.rules.length || this.settings.allow_empty) || h.error("RulesParse", "Incorrect data object passed"), this.clear(), this.setRoot(!1, e.data, this.parseGroupFlags(e)), e = this.change("setRules", e, o);
        var n = this;
        ! function r(e, i) {
            null !== i && (void 0 === e.condition ? e.condition = n.settings.default_condition : -1 == n.settings.conditions.indexOf(e.condition) && (h.error(!o.allow_invalid, "UndefinedCondition", 'Invalid condition "{0}"', e.condition), e.condition = n.settings.default_condition), i.condition = e.condition, e.rules.forEach(function(e) {
                var t;
                if (void 0 !== e.rules)
                    if (-1 !== n.settings.allow_groups && n.settings.allow_groups < i.level) h.error(!o.allow_invalid, "RulesParse", "No more than {0} groups are allowed", n.settings.allow_groups), n.reset();
                    else {
                        if (null === (t = n.addGroup(i, !1, e.data, n.parseGroupFlags(e)))) return;
                        r(e, t)
                    }
                else {
                    if (e.empty || (void 0 === e.id && (h.error(!o.allow_invalid, "RulesParse", "Missing rule field id"), e.empty = !0), void 0 === e.operator && (e.operator = "equal")), null === (t = n.addRule(i, e.data, n.parseRuleFlags(e)))) return;
                    e.empty || (t.filter = n.getFilterById(e.id, !o.allow_invalid)), t.filter && (t.operator = n.getOperatorByType(e.operator, !o.allow_invalid), t.operator || (t.operator = n.getOperators(t.filter)[0])), t.operator && 0 !== t.operator.nb_inputs && (void 0 !== e.value ? t.value = e.value : void 0 !== t.filter.default_value && (t.value = t.filter.default_value)), n.change("jsonToRule", t, e) != t && h.error("RulesParse", "Plugin tried to change rule reference")
                }
            }), n.change("jsonToGroup", i, e) != i && h.error("RulesParse", "Plugin tried to change group reference"))
        }(e, this.model.root), this.trigger("afterSetRules")
    }, c.prototype.validateValue = function(e, t) {
        var r = e.filter.validation || {},
            i = !0;
        return i = r.callback ? r.callback.call(this, t, e) : this._validateValue(e, t), this.change("validateValue", i, t, e)
        ...
        for (var a = 0; a < n.nb_inputs; a++) {
            if (!n.multiple && $.isArray(t[a]) && 1 < t[a].length) {
                s = ["operator_not_multiple", n.type, this.translate("operators", n.type)];
                break
            }
            switch (o.input) {
                case "radio":
                ...
                case "checkbox":
                    ...
                    break;
                case "select":
                    if (void 0 === t[a] || 0 === t[a].length || o.placeholder && t[a] == o.placeholder_value) {
                        l.allow_empty_value || (s = ["select_empty"]);
                        break
                    }
                    break;
                default:
                    i = $.isArray(t[a]) ? t[a] : [t[a]];
                    for (var u = 0; u < i.length; u++) {
                        switch (c.types[o.type]) {
                            case "string":
                                if (void 0 === i[u] || 0 === i[u].length) {
                                    l.allow_empty_value || (s = ["string_empty"]);
                                    break
                                }
                                if (void 0 !== l.min && i[u].length < parseInt(l.min)) {
                                    s = [this.getValidationMessage(l, "min", "string_exceed_min_length"), l.min];
                                    break
                                }
                                if (void 0 !== l.max && i[u].length > parseInt(l.max)) {
                                    s = [this.getValidationMessage(l, "max", "string_exceed_max_length"), l.max];
                                    break
                                }
                                if (l.format && ("string" == typeof l.format && (l.format = new RegExp(l.format)), !l.format.test(i[u]))) {
                            ...
                            case "boolean":
                                ...
                                if ("true" !== (r = ("" + i[u]).trim().toLowerCase()) && "false" !== r && "1" !== r && "0" !== r && 1 !== i[u] && 0 !== i[u]) {
                                    s = ["boolean_not_valid"];
                                    break
                                }
                        }
        ...
        if (("between" === e.operator.type || "not_between" === e.operator.type) && 2 === t.length) switch (c.types[o.type]) {
            case "number":
        ...
        if ("-1" == e) return null;
        for (var r = 0, i = this.filters.length; r < i; r++)
            if (this.filters[r].id == e) return this.filters[r];
        return h.error(!1 !== t, "UndefinedFilter", 'Undefined filter "{0}"', e), null
    }, c.prototype.getOperatorByType = function(e, t) {
        if ("-1" == e) return null;
        for (var r = 0, i = this.operators.length; r < i; r++)
            if (this.operators[r].type == e) return this.operators[r];
        return h.error(!1 !== t, "UndefinedOperator", 'Undefined operator "{0}"', e), null
    }, c.prototype.getRuleInputValue = function(e) {
        var t = e.filter,
            r = e.operator,
            i = [];
        if (t.valueGetter) i = t.valueGetter.call(this, e);
        else {
            for (var o = e.$el.find(c.selectors.value_container), n = 0; n < r.nb_inputs; n++) {
                var l, s = h.escapeElementId(e.id + "_value_" + n);
                switch (t.input) {
                    case "radio":
                        i.push(o.find("[name=" + s + "]:checked").val());
                        break;
                    case "checkbox":
                        l = [], o.find("[name=" + s + "]:checked").each(function() {
                            l.push($(this).val())
                        }), i.push(l);
                        break;
                    case "select":
                        t.multiple ? (l = [], o.find("[name=" + s + "] option:selected").each(function() {
                            l.push($(this).val())
                        }), i.push(l)) : i.push(o.find("[name=" + s + "] option:selected").val());
                        break;
                    default:
                        i.push(o.find("[name=" + s + "]").val())
                }
            }
            i = i.map(function(e) {
            ...
            }), 1 === r.nb_inputs && (i = i[0]), t.valueParser && (i = t.valueParser.call(this, e, i))
        }
        return this.change("getRuleValue", i, e)
    }, c.prototype.setRuleInputValue = function(e, t) {
        var r = e.filter,
            i = e.operator;
        if (r && i) {
            if (e._updating_input = !0, r.valueSetter) r.valueSetter.call(this, e, t);
            else {
                var o = e.$el.find(c.selectors.value_container);
                1 == i.nb_inputs && (t = [t]);
                for (var n = 0; n < i.nb_inputs; n++) {
                    var l = h.escapeElementId(e.id + "_value_" + n);
                    switch (r.input) {
                        case "radio":
                            o.find("[name=" + l + '][value="' + t[n] + '"]').prop("checked", !0).trigger("change");
                            break;
                        case "checkbox":
                            $.isArray(t[n]) || (t[n] = [t[n]]), t[n].forEach(function(e) {
                                o.find("[name=" + l + '][value="' + e + '"]').prop("checked", !0).trigger("change")
                            });
                            break;
                        default:
                            i.multiple && r.value_separator && $.isArray(t[n]) && (t[n] = t[n].join(r.value_separator)), o.find("[name=" + l + "]").val(t[n]).trigger("change")
                    }
                }
            }
            e._updating_input = !1
        ...
        var r = e.filter,
            i = e.filter.validation || {},
            o = e.id + "_value_" + t,
            n = r.vertical ? " class=block" : "",
            l = "";
        if ("function" == typeof r.input) l = r.input.call(this, e, o);
        else switch (r.input) {
            case "radio":
            case "checkbox":
                h.iterateOptions(r.values, function(e, t) {
                    l += "<label" + n + '><input type="' + r.input + '" name="' + o + '" value="' + e + '"> ' + t + "</label> "
                });
                break;
            case "select":
                l = this.getRuleValueSelect(o, e);
                break;
            case "textarea":
                l += '<textarea class="form-control" name="' + o + '"', r.size && (l += ' cols="' + r.size + '"'), r.rows && (l += ' rows="' + r.rows + '"'), void 0 !== i.min && (l += ' minlength="' + i.min + '"'), void 0 !== i.max && (l += ' maxlength="' + i.max + '"'), r.placeholder && (l += ' placeholder="' + r.placeholder + '"'), l += "></textarea>";
                break;
            case "number":
                l += '<input class="form-control" type="number" name="' + o + '"', void 0 !== i.step && (l += ' step="' + i.step + '"'), void 0 !== i.min && (l += ' min="' + i.min + '"'), void 0 !== i.max && (l += ' max="' + i.max + '"'), r.placeholder && (l += ' placeholder="' + r.placeholder + '"'), r.size && (l += ' size="' + r.size + '"'), l += ">";
                break;
            default:
                l += '<input class="form-control" type="text" name="' + o + '"', r.placeholder && (l += ' placeholder="' + r.placeholder + '"'), "string" === r.type && void 0 !== i.min && (l += ' minlength="' + i.min + '"'), "string" === r.type && void 0 !== i.max && (l += ' maxlength="' + i.max + '"'), r.size && (l += ' size="' + r.size + '"'), l += ">"
        }
        return this.change("getRuleInput", l, e, o)
    };
    var h = {};
    ...
    function i() {
        ...
        var e = 0,
            t = "boolean" != typeof arguments[e] || arguments[e++],
            r = arguments[e++],
            i = arguments[e++],
            o = Array.isArray(arguments[e]) ? arguments[e] : Array.prototype.slice.call(arguments, e);
        if (t) {
            var n = new Error(h.fmt(i, o));
            throw n.name = r + "Error", n.args = o, n
        }
        console.error(r + "Error: " + h.fmt(i, o))
        ...
        return e.forEach(function(e) {
            var t;
            e[r] ? -1 == (t = i.lastIndexOf(e[r])) ? t = i.length : t++ : t = i.length, i.splice(t, 0, e[r]), o.splice(t, 0, e)
        }), o
    ...
    var o = function(e, t) {
        ...
        Object.defineProperty(this, "__", {
            value: {}
        }), t.data("queryBuilderModel", this), this.__.level = 1, this.__.error = null, this.__.flags = {}, this.__.data = void 0, this.$el = t, this.id = t[0].id, this.model = null, this.parent = e
    };
    h.defineModelProperties(o, ["level", "error", "data", "flags"]), Object.defineProperty(o.prototype, "parent", {
        enumerable: !0,
        get: function() {
    ...
    }, o.prototype.moveAfter = function(e) {
        this.isRoot() || this.move(e.parent, e.getPos() + 1)
    }, o.prototype.moveAtBegin = function(e) {
        this.isRoot() || (void 0 === e && (e = this.parent), this.move(e, 0))
    }, o.prototype.moveAtEnd = function(e) {
    ...
    var a = function(e, t) {
        ...
        o.call(this, e, t), this.rules = [], this.__.condition = null
    };
    a.prototype = Object.create(o.prototype), a.prototype.constructor = a, h.defineModelProperties(a, ["condition"]), a.prototype.empty = function() {
        ...
        this.empty(), o.prototype.drop.call(this)
        ...
        var t = this.getNodePos(e); - 1 !== t && (e.parent = null, this.rules.splice(t, 1))
    }, a.prototype.getNodePos = function(e) {
        return this.rules.indexOf(e)
    }, a.prototype.each = function(e, t, r, i) {
        "boolean" != typeof e && "string" != typeof e && (i = r, r = t, t = e, e = !1), i = void 0 === i ? null : i;
        for (var o = e ? this.rules.length - 1 : 0, n = e ? 0 : this.rules.length - 1, l = e ? -1 : 1, s = !1;
            (e ? n <= o : o <= n) && (this.rules[o] instanceof a ? r && (s = !1 === r.call(i, this.rules[o])) : t && (s = !1 === t.call(i, this.rules[o])), !s); o += l);
        return !s
    ...
    var l = function(e, t) {
        ...
        o.call(this, e, t), this._updating_value = !1, this._updating_input = !1, this.__.filter = null, this.__.operator = null, this.__.value = void 0
    };

    function u(e, t, r) {
        var i, o, n = c.selectors;
        (i = t.closest(n.rule_container)).length && (o = "moveAfter"), o || (i = t.closest(n.group_header)).length && (i = t.closest(n.group_container), o = "moveAtBegin"), o || (i = t.closest(n.group_container)).length && (o = "moveAtEnd"), o && (e[o](r.getModel(i)), r && e instanceof l && r.setRuleInputValue(e, e.value))
    }
    ...
    return l.prototype = Object.create(o.prototype), l.prototype.constructor = l, h.defineModelProperties(l, ["filter", "operator", "value"]), l.prototype.isRoot = function() {
        return !1
        ...
        var t = this.data("queryBuilder"),
            r = "object" == typeof e && e || {};
        if (!t && "destroy" == e) return this;
        if (!t) {
            var i = new c(this, r);
            this.data("queryBuilder", i), i.init(r.rules)
        }
        ...
        "glyphicons" == u.font && this.$el.addClass("bt-checkbox-glyphicons"), this.on("getRuleInput.filter", function(o, e, n) {
            var l = e.filter;
            if (("radio" === l.input || "checkbox" === l.input) && !l.plugin) {
                o.value = "", l.colors || (l.colors = {}), l.color && (l.colors._def_ = l.color);
                var s = l.vertical ? ' style="display:block"' : "",
                    a = 0;
                h.iterateOptions(l.values, function(e, t) {
                    var r = l.colors[e] || l.colors._def_ || u.color,
                        i = n + "_" + a++;
                    o.value += "<div" + s + ' class="' + l.input + " " + l.input + "-" + r + '">   <input type="' + l.input + '" name="' + n + '" id="' + i + '" value="' + e + '">   <label for="' + i + '">' + t + "</label> </div>"
                })
            }
        })
    }, {
        font: "glyphicons",
        color: "default"
    }), c.define("bt-selectpicker", function(r) {
        ...
        this.on("afterCreateRuleFilters", function(e, t) {
            t.$el.find(i.rule_filter).removeClass("form-control").selectpicker(r)
        }), this.on("afterCreateRuleOperators", function(e, t) {
            t.$el.find(i.rule_operator).removeClass("form-control").selectpicker(r)
        }), this.on("afterUpdateRuleFilter", function(e, t) {
            t.$el.find(i.rule_filter).selectpicker("render")
        }), this.on("afterUpdateRuleOperator", function(e, t) {
            t.$el.find(i.rule_operator).selectpicker("render")
        }), this.on("beforeDeleteRule", function(e, t) {
            t.$el.find(i.rule_filter).selectpicker("destroy"), t.$el.find(i.rule_operator).selectpicker("destroy")
        })
    }, {
        container: "body",
        ...
        width: "auto",
        showIcon: !1
    }), c.define("bt-tooltip-errors", function(i) {
        ...
        this.on("getRuleTemplate.filter getGroupTemplate.filter", function(e) {
            ...
            "error" == r && o.settings.display_errors && t.$el.find(c.selectors.error_container).eq(0).tooltip(i).tooltip("hide").tooltip("fixTitle")
        })
    }, {
        placement: "right"
    }), c.extend({
        setFilters: function(e, t) {
            ...
            var i = (t = this.change("setFilters", t)).map(function(e) {
                return e.id
            });
            if (e || function e(t) {
                    t.each(function(e) {
                        e.filter && -1 === i.indexOf(e.filter.id) && h.error("ChangeFilter", 'A rule is using filter "{0}"', e.filter.id)
                    }, e)
                }(this.model.root), this.filters = t, function e(t) {
                    t.each(!0, function(e) {
                        e.filter && -1 === i.indexOf(e.filter.id) ? (e.drop(), r.trigger("rulesChanged")) : (r.createRuleFilters(e), e.$el.find(c.selectors.rule_filter).val(e.filter ? e.filter.id : "-1"), r.trigger("afterUpdateRuleFilter", e))
                    }, e)
        ...
        var i = c.selectors;
        this.on("afterCreateRuleFilters", function(e, t) {
            t.$el.find(i.rule_filter).removeClass("form-control").chosen(r)
        }), this.on("afterCreateRuleOperators", function(e, t) {
            t.$el.find(i.rule_operator).removeClass("form-control").chosen(r)
        }), this.on("afterUpdateRuleFilter", function(e, t) {
            t.$el.find(i.rule_filter).trigger("chosen:updated")
        }), this.on("afterUpdateRuleOperator", function(e, t) {
            t.$el.find(i.rule_operator).trigger("chosen:updated")
        }), this.on("beforeDeleteRule", function(e, t) {
            t.$el.find(i.rule_filter).chosen("destroy"), t.$el.find(i.rule_operator).chosen("destroy")
        })
    }), c.define("filter-description", function(o) {
        "inline" === o.mode ? this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function(e, t) {
            var r = t.$el.find("p.filter-description"),
                i = e.builder.getFilterDescription(t.filter, t);
            i ? (0 === r.length ? (r = $('<p class="filter-description"></p>')).appendTo(t.$el) : r.css("display", ""), r.html('<i class="' + o.icon + '"></i> ' + i)) : r.hide()
        }) : "popover" === o.mode ? ($.fn.popover && $.fn.popover.Constructor && $.fn.popover.Constructor.prototype.fixTitle || h.error("MissingLibrary", 'Bootstrap Popover is required to use "filter-description" plugin. Get it here: http://getbootstrap.com'), this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function(e, t) {
            var r = t.$el.find("button.filter-description"),
                i = e.builder.getFilterDescription(t.filter, t);
            i ? (0 === r.length ? ((r = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="popover"><i class="' + o.icon + '"></i></button>')).prependTo(t.$el.find(c.selectors.rule_actions)), r.popover({
                placement: "left",
                container: "body",
                html: !0
            }), r.on("mouseout", function() {
                r.popover("hide")
            })) : r.css("display", ""), r.data("bs.popover").options.content = i, r.attr("aria-describedby") && r.popover("show")) : (r.hide(), r.data("bs.popover") && r.popover("hide"))
        })) : "bootbox" === o.mode && ("bootbox" in window || h.error("MissingLibrary", 'Bootbox is required to use "filter-description" plugin. Get it here: http://bootboxjs.com'), this.on("afterUpdateRuleFilter afterUpdateRuleOperator", function(e, t) {
            var r = t.$el.find("button.filter-description"),
                i = e.builder.getFilterDescription(t.filter, t);
            i ? (0 === r.length ? ((r = $('<button type="button" class="btn btn-xs btn-info filter-description" data-toggle="bootbox"><i class="' + o.icon + '"></i></button>')).prependTo(t.$el.find(c.selectors.rule_actions)), r.on("click", function() {
                bootbox.alert(r.data("description"))
            })) : r.css("display", ""), r.data("description", i)) : r.hide()
        }))
    }, {
        ...
        this.on("afterInit", function() {
            i.$el.on("click.queryBuilder", "[data-invert=group]", function() {
                var e = $(this).closest(o.group_container);
                i.invert(i.getModel(e), r)
            }), r.display_rules_button && r.invert_rules && i.$el.on("click.queryBuilder", "[data-invert=rule]", function() {
                var e = $(this).closest(o.rule_container);
                i.invert(i.getModel(e), r)
            })
        }), r.disable_template || (this.on("getGroupTemplate.filter", function(e) {
            var t = $(e.value);
            t.find(o.condition_container).after('<button type="button" class="btn btn-xs btn-default" data-invert="group"><i class="' + r.icon + '"></i> ' + i.translate("invert") + "</button>"), e.value = t.prop("outerHTML")
        }), r.display_rules_button && r.invert_rules && this.on("getRuleTemplate.filter", function(e) {
            var t = $(e.value);
            t.find(o.rule_actions).prepend('<button type="button" class="btn btn-xs btn-default" data-invert="rule"><i class="' + r.icon + '"></i> ' + i.translate("invert") + "</button>"), e.value = t.prop("outerHTML")
        }))
    }, {
        ...
        invert: function(e, t) {
            ...
            } else if (e instanceof l && e.operator && !e.filter.no_invert)
                if (this.settings.operatorOpposites[e.operator.type]) {
                    var i = this.settings.operatorOpposites[e.operator.type];
                    e.filter.operators && -1 == e.filter.operators.indexOf(i) || (e.operator = this.getOperatorByType(i))
        ...
        mongoRuleOperators: {
            $eq: function(e) {
                return {
                    val: e,
                    op: null === e ? "is_null" : "" === e ? "is_empty" : "equal"
                }
            },
            $ne: function(e) {
                return {
                    val: e = e.$ne,
                    op: null === e ? "is_not_null" : "" === e ? "is_not_empty" : "not_equal"
                }
            },
            $regex: function(e) {
        ...
        getMongo: function(e) {
            ...
            return function o(e) {
                ...
                e.rules.forEach(function(e) {
                    if (e.rules && 0 < e.rules.length) n.push(o(e));
                    else {
                        var t = l.settings.mongoOperators[e.operator],
                            r = l.getOperatorByType(e.operator);
                        ...
                        var i = {};
                        i[l.change("getMongoDBField", e.field, e)] = t.call(l, e.value), n.push(l.change("ruleToMongo", i, e, e.value, t))
                    }
                });
                var t = {};
                return t["$" + e.condition.toLowerCase()] = n, l.change("groupToMongo", t, e)
            }(e)
        },
        getRulesFromMongo: function(e) {
            ...
            return t || h.error("MongoParse", "Invalid MongoDB query format"),
                function u(e, t) {
                    var r = e[t],
                        p = [];
                    return r.forEach(function(e) {
                        if ("rules" in (e = d.change("parseMongoNode", e)) && "condition" in e) p.push(e);
                        else if ("id" in e && "operator" in e && "value" in e) p.push(e);
                        else {
                            var t = d.getMongoCondition(e);
                            if (t) p.push(u(e, t));
                            else {
                                var r = Object.keys(e)[0],
                                    i = e[r],
                                    o = d.getMongoOperator(i);
                                void 0 === o && h.error("MongoParse", "Invalid MongoDB query format");
                                var n = d.settings.mongoRuleOperators[o];
                                void 0 === n && h.error("UndefinedMongoOperator", 'JSON Rule operation unknown for operator "{0}"', o);
                                var l = n.call(d, i),
                                    s = d.getMongoDBFieldID(r, i),
                                    a = d.change("mongoToRule", {
                                        id: s,
                                        field: r,
                                        operator: l.op,
                                        value: l.val
                    ...
                    }), d.change("mongoToGroup", {
                        condition: t.replace("$", "").toUpperCase(),
                        rules: p
                    }, e)
                }(e, t)
        },
        ...
        getMongoCondition: function(e) {
            for (var t = Object.keys(e), r = 0, i = t.length; r < i; r++)
                if ("$or" === t[r].toLowerCase() || "$and" === t[r].toLowerCase()) return t[r]
        }
    }), c.define("not-group", function(r) {
        var i = this;
        this.on("afterInit", function() {
            i.$el.on("click.queryBuilder", "[data-not=group]", function() {
                var e = $(this).closest(c.selectors.group_container),
                    t = i.getModel(e);
                t.not = !t.not
            }), i.model.on("update", function(e, t, r) {
                t instanceof a && "not" === r && i.updateGroupNot(t)
            })
        }), this.on("afterAddGroup", function(e, t) {
            t.__.not = !1
        }), r.disable_template || this.on("getGroupTemplate.filter", function(e) {
            var t = $(e.value);
            t.find(c.selectors.condition_container).prepend('<button type="button" class="btn btn-xs btn-default" data-not="group"><i class="' + r.icon_unchecked + '"></i> ' + i.translate("NOT") + "</button>"), e.value = t.prop("outerHTML")
            ...
            e.value.name && "NOT" == e.value.name.toUpperCase() && (e.value = e.value.arguments.value[0], -1 === ["AND", "OR"].indexOf(e.value.operation.toUpperCase()) && (e.value = new SQLParser.nodes.Op(i.settings.default_condition, e.value, null)), e.value.not = !0)
        }), this.on("sqlGroupsDistinct.filter", function(e, t, r, i) {
            r.not && 0 < i && (e.value = !0)
        }), this.on("sqlToGroup.filter", function(e, t) {
            e.value.not = !!t.not
        }), this.on("groupToMongo.filter", function(e, t) {
            var r = "$" + t.condition.toLowerCase();
            t.not && e.value[r] && (e.value = {
                $nor: [e.value]
            })
        ...
        "interact" in window || h.error("MissingLibrary", 'interact.js is required to use "sortable" plugin. Get it here: http://interactjs.io'), void 0 !== i.default_no_sortable && (h.error(!1, "Config", 'Sortable plugin : "default_no_sortable" options is deprecated, use standard "default_rule_flags" and "default_group_flags" instead'), this.settings.default_rule_flags.no_sortable = this.settings.default_group_flags.no_sortable = i.default_no_sortable), interact.dynamicDrop(!0), interact.pointerMoveTolerance(10), this.on("afterAddRule afterAddGroup", function(e, t) {
            if (t != o) {
                var r = e.builder;
                i.inherit_no_sortable && t.parent && t.parent.flags.no_sortable && (t.flags.no_sortable = !0), i.inherit_no_drop && t.parent && t.parent.flags.no_drop && (t.flags.no_drop = !0), t.flags.no_sortable || interact(t.$el[0]).draggable({
                    allowFrom: c.selectors.drag_handle,
                    onstart: function(e) {
                        s = !1, l = r.getModel(e.target), n = l.$el.clone().appendTo(l.$el.parent()).width(l.$el.outerWidth()).addClass("dragging");
                        var t = $('<div class="rule-placeholder">&nbsp;</div>').height(l.$el.outerHeight());
                        o = l.parent.addRule(t, l.getPos()), l.$el.hide()
                    },
                    onmove: function(e) {
                        n[0].style.top = e.clientY - 15 + "px", n[0].style.left = e.clientX - 15 + "px"
                    },
                    onend: function(e) {
                        e.dropzone && (u(l, $(e.relatedTarget), r), s = !0), n.remove(), n = void 0, o.drop(), o = void 0, l.$el.css("display", ""), r.trigger("afterMove", l), r.trigger("rulesChanged")
                    }
        ...
        }), i.disable_template || (this.on("getGroupTemplate.filter", function(e, t) {
            if (1 < t) {
                var r = $(e.value);
                r.find(c.selectors.condition_container).after('<div class="drag-handle"><i class="' + i.icon + '"></i></div>'), e.value = r.prop("outerHTML")
            }
        }), this.on("getRuleTemplate.filter", function(e) {
            var t = $(e.value);
            t.find(c.selectors.rule_header).after('<div class="drag-handle"><i class="' + i.icon + '"></i></div>'), e.value = t.prop("outerHTML")
        }))
    }, {
        ...
        sqlStatements: {
            ...
            named: function(i) {
                ...
                return {
                    add: function(e, t) {
                        o[e.field] || (o[e.field] = 1);
                        var r = e.field + "_" + o[e.field]++;
                        return n[r] = t, i + r
                    },
                    run: function() {
                        return n
        ...
        sqlRuleStatement: {
            ...
            numbered: function(t, r) {
                (!r || 1 < r.length) && (r = "$");
                var i = new RegExp("^\\" + r + "[0-9]+$"),
                    o = new RegExp("\\" + r + "([0-9]+)", "g");
                return {
                    parse: function(e) {
                        return i.test(e) ? t[e.slice(1) - 1] : e
                    },
                    esc: function(e) {
                        return e.replace(o, "'" + ("$" == r ? "$$" : r) + "$1'")
                    }
                }
            },
            named: function(t, r) {
                (!r || 1 < r.length) && (r = ":");
                var i = new RegExp("^\\" + r),
                    o = new RegExp("\\" + r + "(" + Object.keys(t).join("|") + ")", "g");
                return {
                    parse: function(e) {
                        return i.test(e) ? t[e.slice(1)] : e
                    },
                    esc: function(e) {
                        return e.replace(o, "'" + ("$" == r ? "$$" : r) + "$1'")
                    }
            ...
            var d = this,
                r = function l(e) {
                    ...
                    e.rules.forEach(function(r) {
                        if (r.rules && 0 < r.rules.length) s.push("(" + u + l(r) + u + ")" + u);
                        else {
                            var i = d.settings.sqlOperators[r.operator],
                                e = d.getOperatorByType(r.operator),
                                o = "";
                            void 0 === i && h.error("UndefinedSQLOperator", 'Unknown SQL operation for operator "{0}"', r.operator), 0 !== e.nb_inputs && (r.value instanceof Array || (r.value = [r.value]), r.value.forEach(function(e, t) {
                                0 < t && (o += i.sep), "boolean" == r.type && p ? e = e ? 1 : 0 : a || "integer" === r.type || "double" === r.type || "boolean" === r.type || (e = h.escapeString(e)), i.mod && (e = h.fmt(i.mod, e)), a ? o += a.add(r, e) : ("string" == typeof e && (e = "'" + e + "'"), o += e)
                            }));
                            var t = function(e) {
                                    return i.op.replace("?", function() {
                                        return e
                                    })
                                },
                                n = d.change("getSQLField", r.field, r) + " " + t(o);
                            s.push(d.change("ruleToSQL", n, r, o, t))
                        }
                    });
        ...
        getRulesFromSQL: function(e, c) {
            ...
            if ("string" == typeof e && (e = {
                    sql: e
                }), !0 === c && (c = "question_mark"), "string" == typeof c) {
                var t = n(c);
            ...
            var i = f.change("parseSQLNode", r.where.conditions);
            if ("rules" in i && "condition" in i) return i;
            if ("id" in i && "operator" in i && "value" in i) return {
                condition: this.settings.default_condition,
                rules: [i]
            };
            var o = f.change("sqlToGroup", {
                    condition: this.settings.default_condition,
                    rules: []
                }, i),
                g = o;
            return function e(t, r) {
                if (null !== t)
                    if ("rules" in (t = f.change("parseSQLNode", t)) && "condition" in t) g.rules.push(t);
                    else if ("id" in t && "operator" in t && "value" in t) g.rules.push(t);
                else if ("left" in t && "right" in t && "operation" in t || h.error("SQLParse", "Unable to parse WHERE clause"), -1 !== ["AND", "OR"].indexOf(t.operation.toUpperCase())) {
                    if (f.change("sqlGroupsDistinct", 0 < r && g.condition != t.operation.toUpperCase(), g, t, r)) {
                        var i = f.change("sqlToGroup", {
                            condition: f.settings.default_condition,
                            rules: []
                        }, t);
                        g.rules.push(i), g = i
                    }
                    ...
                    var o = g;
                    e(t.left, r), g = o, e(t.right, r)
                } else {
                    var n;
                    $.isPlainObject(t.right.value) && h.error("SQLParse", "Value format not supported for {0}.", t.left.value), n = $.isArray(t.right.value) ? t.right.value.map(function(e) {
                        return e.value
                    }) : t.right.value, c && (n = $.isArray(n) ? n.map(c.parse) : c.parse(n));
                    ...
                    var a, u = s.call(this, n, t.operation);
                    ...
                    var p = f.getSQLFieldID(a, n),
                        d = f.change("sqlToRule", {
                            id: p,
                            field: a,
                            operator: u.op,
                            value: u.val
        ...
        this.status.used_filters = {}, this.on("afterUpdateRuleFilter", this.updateDisabledFilters), this.on("afterDeleteRule", this.updateDisabledFilters), this.on("afterCreateRuleFilters", this.applyDisabledFilters), this.on("afterReset", this.clearDisabledFilters), this.on("afterClear", this.clearDisabledFilters), this.on("getDefaultFilter.filter", function(t, r) {
            var i = t.builder;
            (i.updateDisabledFilters(), t.value.id in i.status.used_filters) && (i.filters.some(function(e) {
                if (!(e.id in i.status.used_filters) || 0 < i.status.used_filters[e.id].length && -1 === i.status.used_filters[e.id].indexOf(r.parent)) return t.value = e, !0
