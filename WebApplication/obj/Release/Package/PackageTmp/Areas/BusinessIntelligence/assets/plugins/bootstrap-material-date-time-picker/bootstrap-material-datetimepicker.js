   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-clear  custom-btn medium color2 hidden">' + this.params.clearText + '</button>' +
                         '<button class="dtp-btn-cancel  custom-btn medium color3">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok  custom-btn medium color4">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
