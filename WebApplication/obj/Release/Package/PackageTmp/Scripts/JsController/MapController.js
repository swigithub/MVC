var app = angular.module('mainApp', [ "ngMap", 'ui.bootstrap', 'popoverToggle', 'colorpicker.module', 'ngSanitize']);



app.controller('mapCtrl', function ($scope, $http, $location, NgMap) {
