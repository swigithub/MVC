        ...
        return {
            ...
            link: function (originalScope, element, attrs, modelCtrl) {
                ...
                var exp = attrs.options,
                  ...
                  isMultiple = attrs.multiple && attrs.multiple == 'true',
                  showCheckUncheckAll = attrs.showcheckuncheckall && attrs.showcheckuncheckall == 'true',
                  required = false,
                ...
                scope.showCheckUncheckAll = isMultiple && showCheckUncheckAll;
                ...
                function getHeaderText() {
                    if (is_empty(modelCtrl.$modelValue) || modelCtrl.$modelValue.length == 0) return scope.header = attrs.msHeader || 'Select';
  ...
  .directive('multiselectPopup', ['$document', function ($document) {
      return {
          ...
          templateUrl: function (element, attr) {
              return attr.templateUrl || '/Content/js/Plugins/angularmultislect/multiselect.tmpl.html';
          },
