...
{
    public partial class ReportCriteria : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("DriveStatusDataSet", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/DriveStatusReport.rdlc");
        ...
        private DataTable GetData(string where)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("AV_rptDriveWOStatus", cn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@Where", SqlDbType.NVarChar).Value = where;

                    cmd.Parameters.Add("@Filter", SqlDbType.VarChar).Value = "Drive_WO_Status";
