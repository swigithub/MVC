...
{
    public partial class UtilizationPerMarket : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("UtilizationPerMarketDataSet", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/UtilizationPerMarket.rdlc");
        ...
        private DataTable GetData(string where)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("AV_rptUtilizationPerMarket", cn);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.Add("@Where", SqlDbType.NVarChar).Value = where;
                cmd.Parameters.Add("@Filter", SqlDbType.VarChar).Value = "Use_Per_Market";
