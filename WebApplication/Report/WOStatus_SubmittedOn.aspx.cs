...
{
    public partial class WOStatus_SubmittedOn : System.Web.UI.Page
    {
        ...
        private void ShowReport() {
          ...
          string  where = txtwhere.Text;
            ...
            ReportDataSource rds = new ReportDataSource("SubmittedOnDataSet", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/WOStatus_SubmittedOn.rdlc");
        ...
        private DataTable GetData(string where)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("AV_rptSubmittedOnWOStatus", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                
                cmd.Parameters.Add("@Where", SqlDbType.NVarChar).Value = where;
                cmd.Parameters.Add("@Filter", SqlDbType.VarChar).Value = "SubmittedOn_WO_Status";
