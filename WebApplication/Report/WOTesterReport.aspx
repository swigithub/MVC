<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WOTesterReport.aspx.cs" Inherits="WebApplication.Report.WOTesterReport" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:Button ID="btnreport" runat="server" CssClass="btn btn-info pull-right" OnClientClick="call()" Text="View Report" OnClick="btnreport_Click" />
                            <div class="box-body">
                                ...
                                <center>
            <rsweb:ReportViewer ID="ReportViewer1" AsyncRendering="False" ZoomMode="FullPage" SizeToReportContent="True" Width="100%" Height="100%" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
