<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WOStatus_SubmittedOn.aspx.cs" Inherits="WebApplication.Report.WOStatus_SubmittedOn" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                             <asp:Button ID="GetReports" CssClass="btn btn-info pull-right" OnClientClick="call()" runat="server" Text="View Report" OnClick="GetReports_Click" />
                            <div class="box-body">
