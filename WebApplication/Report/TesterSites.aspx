<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TesterSites.aspx.cs" Inherits="WebApplication.Report.TesterSites" %>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="box-body">
                                <div class="btn-group pull-right" style="margin-top: 20px">
                                    <asp:Button ID="GetReports" OnClientClick="call()" CssClass="btn btn-info" runat="server" Text="GetReports" OnClick="GetReports_Click" />
