...
{
    public partial class WOTesterReport : System.Web.UI.Page
    {
        ...
        private void ShowReport() {
          ...
          string  where = txtwhere.Text;
            ...
            ReportDataSource rds = new ReportDataSource("WO_Tester_DataSet", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/WOStatus_Tester.rdlc");
        ...
        private DataTable GetData(string where)
        {
           where = txtwhere.Text;
            ...
            {
                SqlCommand cmd = new SqlCommand("AV_rptWOStatus", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                
                cmd.Parameters.Add("@Where", SqlDbType.NVarChar).Value = where;
                cmd.Parameters.Add("@Filter", SqlDbType.VarChar).Value = "Tester_WO_Status";
